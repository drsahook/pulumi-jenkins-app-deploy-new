...
export interface ShareArgs {
     ...
     * Access protocol to be used by the share.
     */
    readonly accessProtocol: pulumi.Input<string | enums.databoxedge.v20190701.ShareAccessProtocol>;
    /**
     * Azure container mapping for the share.
     */
    readonly azureContainerInfo?: pulumi.Input<inputs.databoxedge.v20190701.AzureContainerInfoArgs>;
    /**
     * List of IP addresses and corresponding access rights on the share(required for NFS protocol).
     */
    readonly clientAccessRights?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20190701.ClientAccessRightArgs>[]>;
    /**
     * Data policy of the share.
     */
    readonly dataPolicy?: pulumi.Input<string | enums.databoxedge.v20190701.DataPolicy>;
    /**
     * Description for the share.
     */
     ...
     * Current monitoring status of the share.
     */
    readonly monitoringStatus: pulumi.Input<string | enums.databoxedge.v20190701.MonitoringStatus>;
    /**
     * The share name.
     */
     ...
     * Details of the refresh job on this share.
     */
    readonly refreshDetails?: pulumi.Input<inputs.databoxedge.v20190701.RefreshDetailsArgs>;
    /**
     ...
     * Current status of the share.
     */
    readonly shareStatus: pulumi.Input<string | enums.databoxedge.v20190701.ShareStatus>;
    /**
     * Mapping of users and corresponding access rights on the share (required for SMB protocol).
     */
    readonly userAccessRights?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20190701.UserAccessRightArgs>[]>;
}
