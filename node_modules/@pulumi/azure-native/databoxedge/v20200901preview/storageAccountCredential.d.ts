...
export interface StorageAccountCredentialArgs {
     ...
     * Encrypted storage key.
     */
    readonly accountKey?: pulumi.Input<inputs.databoxedge.v20200901preview.AsymmetricEncryptedSecretArgs>;
    /**
     * Type of storage accessed on the storage account.
     */
    readonly accountType: pulumi.Input<string | enums.databoxedge.v20200901preview.AccountType>;
    /**
     * Alias for the storage account.
     */
     ...
     * Signifies whether SSL needs to be enabled or not.
     */
    readonly sslStatus: pulumi.Input<string | enums.databoxedge.v20200901preview.SSLStatus>;
    /**
     * Id of the storage account.
     */
