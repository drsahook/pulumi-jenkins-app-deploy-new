...
export declare class ServerGroup extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerGroup;
    /**
     ...
     */
    readonly delegatedSubnetArguments: pulumi.Output<outputs.dbforpostgresql.v20201005privatepreview.ServerGroupPropertiesResponseDelegatedSubnetArguments | undefined>;
    /**
     ...
     */
    readonly enableMx: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly enableZfs: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly maintenanceWindow: pulumi.Output<outputs.dbforpostgresql.v20201005privatepreview.MaintenanceWindowResponse | undefined>;
    /**
     ...
     */
    readonly privateDnsZoneArguments: pulumi.Output<outputs.dbforpostgresql.v20201005privatepreview.ServerGroupPropertiesResponsePrivateDnsZoneArguments | undefined>;
    /**
     ...
     */
    readonly resourceProviderType: pulumi.Output<string>;
    /**
     * The list of server role groups.
     */
    readonly serverRoleGroups: pulumi.Output<outputs.dbforpostgresql.v20201005privatepreview.ServerRoleGroupResponse[] | undefined>;
    /**
     * The source server group id for read replica server groups.
     */
    readonly sourceServerGroup: pulumi.Output<string>;
    /**
     * Standby Availability Zone information of the server group.
     */
    readonly standbyAvailabilityZone: pulumi.Output<string | undefined>;
    /**
