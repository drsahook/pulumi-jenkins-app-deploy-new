...
export declare class Project extends pulumi.CustomResource {
     ...
     */
    readonly sourceConnectionInfo: pulumi.Output<outputs.datamigration.MiSqlConnectionInfoResponse | outputs.datamigration.MySqlConnectionInfoResponse | outputs.datamigration.PostgreSqlConnectionInfoResponse | outputs.datamigration.SqlConnectionInfoResponse | undefined>;
    /**
     ...
     */
    readonly targetConnectionInfo: pulumi.Output<outputs.datamigration.MiSqlConnectionInfoResponse | outputs.datamigration.MySqlConnectionInfoResponse | outputs.datamigration.PostgreSqlConnectionInfoResponse | outputs.datamigration.SqlConnectionInfoResponse | undefined>;
    /**
...
export interface ProjectArgs {
     ...
     * Source platform for the project
     */
    readonly sourcePlatform: pulumi.Input<string | enums.datamigration.ProjectSourcePlatform>;
    /**
     * Resource tags.
     */
     ...
     * Target platform for the project
     */
    readonly targetPlatform: pulumi.Input<string | enums.datamigration.ProjectTargetPlatform>;
}
