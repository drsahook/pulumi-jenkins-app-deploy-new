...
class WebPubSub extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            inputs["publicNetworkAccess"] = (_a = (args ? args.publicNetworkAccess : undefined)) !== null && _a !== void 0 ? _a : "Enabled";
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:webpubsub:WebPubSub" }, { type: "azure-native:webpubsub/v20210401preview:WebPubSub" }, { type: "azure-nextgen:webpubsub/v20210401preview:WebPubSub" }] };
...
/** @internal */
WebPubSub.__pulumiType = 'azure-native:webpubsub:WebPubSub';
