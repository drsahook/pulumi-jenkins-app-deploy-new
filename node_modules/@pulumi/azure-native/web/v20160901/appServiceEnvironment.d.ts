...
export declare class AppServiceEnvironment extends pulumi.CustomResource {
     ...
     */
    readonly clusterSettings: pulumi.Output<outputs.web.v20160901.NameValuePairResponse[] | undefined>;
    /**
     ...
     */
    readonly environmentCapacities: pulumi.Output<outputs.web.v20160901.StampCapacityResponse[]>;
    /**
     ...
     */
    readonly networkAccessControlList: pulumi.Output<outputs.web.v20160901.NetworkAccessControlEntryResponse[] | undefined>;
    /**
     ...
     */
    readonly vipMappings: pulumi.Output<outputs.web.v20160901.VirtualIPMappingResponse[]>;
    /**
     * Description of the Virtual Network.
     */
    readonly virtualNetwork: pulumi.Output<outputs.web.v20160901.VirtualNetworkProfileResponse>;
    /**
     ...
     */
    readonly workerPools: pulumi.Output<outputs.web.v20160901.WorkerPoolResponse[]>;
    /**
...
export interface AppServiceEnvironmentArgs {
     ...
     * Custom settings for changing the behavior of the App Service Environment.
     */
    readonly clusterSettings?: pulumi.Input<pulumi.Input<inputs.web.v20160901.NameValuePairArgs>[]>;
    /**
     * DNS suffix of the App Service Environment.
     */
     ...
     * Access control list for controlling traffic to the App Service Environment.
     */
    readonly networkAccessControlList?: pulumi.Input<pulumi.Input<inputs.web.v20160901.NetworkAccessControlEntryArgs>[]>;
    /**
     ...
     * Description of the Virtual Network.
     */
    readonly virtualNetwork: pulumi.Input<inputs.web.v20160901.VirtualNetworkProfileArgs>;
    /**
     * Name of the Virtual Network for the App Service Environment.
     */
     ...
     * Description of worker pools with worker size IDs, VM sizes, and number of workers in each pool.
     */
    readonly workerPools: pulumi.Input<pulumi.Input<inputs.web.v20160901.WorkerPoolArgs>[]>;
}
