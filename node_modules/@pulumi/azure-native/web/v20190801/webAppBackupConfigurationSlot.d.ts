...
export declare class WebAppBackupConfigurationSlot extends pulumi.CustomResource {
     ...
     */
    readonly backupSchedule: pulumi.Output<outputs.web.v20190801.BackupScheduleResponse | undefined>;
    /**
     * Databases included in the backup.
     */
    readonly databases: pulumi.Output<outputs.web.v20190801.DatabaseBackupSettingResponse[] | undefined>;
    /**
...
export interface WebAppBackupConfigurationSlotArgs {
     ...
     * Schedule for the backup if it is executed periodically.
     */
    readonly backupSchedule?: pulumi.Input<inputs.web.v20190801.BackupScheduleArgs>;
    /**
     * Databases included in the backup.
     */
    readonly databases?: pulumi.Input<pulumi.Input<inputs.web.v20190801.DatabaseBackupSettingArgs>[]>;
    /**
     * True if the backup schedule is enabled (must be included in that case), false if the backup schedule should be disabled.
     */
