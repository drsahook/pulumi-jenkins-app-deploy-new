...
export interface SourceControlConfigurationArgs {
     ...
     * Scope at which the operator will be installed.
     */
    readonly operatorScope?: pulumi.Input<string | enums.kubernetesconfiguration.OperatorScopeType>;
    /**
     * Type of the operator
     */
    readonly operatorType?: pulumi.Input<string | enums.kubernetesconfiguration.OperatorType>;
    /**
     * Url of the SourceControl Repository.
     */
