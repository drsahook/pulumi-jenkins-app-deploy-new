...
export declare class SourceControlConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly complianceStatus: pulumi.Output<outputs.kubernetesconfiguration.v20201001preview.ComplianceStatusResponse>;
    /**
     ...
     */
    readonly helmOperatorProperties: pulumi.Output<outputs.kubernetesconfiguration.v20201001preview.HelmOperatorPropertiesResponse | undefined>;
    /**
     * Resource name
     */
     ...
     */
    readonly systemData: pulumi.Output<outputs.kubernetesconfiguration.v20201001preview.SystemDataResponse | undefined>;
    /**
     * Resource type
     */
...
export interface SourceControlConfigurationArgs {
     ...
     * Name-value pairs of protected configuration settings for the configuration
     */
    readonly configurationProtectedSettings?: pulumi.Input<{
     ...
     * Properties for Helm operator.
     */
    readonly helmOperatorProperties?: pulumi.Input<inputs.kubernetesconfiguration.v20201001preview.HelmOperatorPropertiesArgs>;
    /**
     * Instance name of the operator - identifying the specific configuration.
     */
     ...
     * Scope at which the operator will be installed.
     */
    readonly operatorScope?: pulumi.Input<string | enums.kubernetesconfiguration.v20201001preview.OperatorScopeType>;
    /**
     * Type of the operator
     */
    readonly operatorType?: pulumi.Input<string | enums.kubernetesconfiguration.v20201001preview.OperatorType>;
    /**
     * Url of the SourceControl Repository.
     */
