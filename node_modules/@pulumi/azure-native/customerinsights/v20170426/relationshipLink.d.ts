...
export declare class RelationshipLink extends pulumi.CustomResource {
     ...
     */
    readonly mappings: pulumi.Output<outputs.customerinsights.v20170426.RelationshipLinkFieldMappingResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    readonly profilePropertyReferences: pulumi.Output<outputs.customerinsights.v20170426.ParticipantProfilePropertyReferenceResponse[]>;
    /**
     * Provisioning state.
     */
     ...
     */
    readonly relatedProfilePropertyReferences: pulumi.Output<outputs.customerinsights.v20170426.ParticipantProfilePropertyReferenceResponse[]>;
    /**
...
export interface RelationshipLinkArgs {
     ...
     * The mappings between Interaction and Relationship fields.
     */
    readonly mappings?: pulumi.Input<pulumi.Input<inputs.customerinsights.v20170426.RelationshipLinkFieldMappingArgs>[]>;
    /**
     * The property references for the Profile of the Relationship.
     */
    readonly profilePropertyReferences: pulumi.Input<pulumi.Input<inputs.customerinsights.v20170426.ParticipantProfilePropertyReferenceArgs>[]>;
    /**
     * The property references for the Related Profile of the Relationship.
     */
    readonly relatedProfilePropertyReferences: pulumi.Input<pulumi.Input<inputs.customerinsights.v20170426.ParticipantProfilePropertyReferenceArgs>[]>;
    /**
     * The name of the relationship link.
     */
