...
export declare class OperationByProviderRegistration extends pulumi.CustomResource {
     ...
     */
    readonly display: pulumi.Output<outputs.providerhub.OperationsDefinitionResponseDisplay>;
    /**
...
export interface OperationByProviderRegistrationArgs {
    readonly contents: pulumi.Input<pulumi.Input<inputs.providerhub.OperationsDefinitionArgs>[]>;
    /**
