...
export declare class PacketCapture extends pulumi.CustomResource {
     ...
     */
    readonly filters: pulumi.Output<outputs.network.v20190801.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    readonly storageLocation: pulumi.Output<outputs.network.v20190801.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
     ...
     * A list of packet capture filters.
     */
    readonly filters?: pulumi.Input<pulumi.Input<inputs.network.v20190801.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * Describes the storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Input<inputs.network.v20190801.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
