...
export declare class AzureFirewall extends pulumi.CustomResource {
     ...
     */
    readonly applicationRuleCollections: pulumi.Output<outputs.network.v20180701.AzureFirewallApplicationRuleCollectionResponse[] | undefined>;
    /**
     ...
     */
    readonly ipConfigurations: pulumi.Output<outputs.network.v20180701.AzureFirewallIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly networkRuleCollections: pulumi.Output<outputs.network.v20180701.AzureFirewallNetworkRuleCollectionResponse[] | undefined>;
    /**
...
export interface AzureFirewallArgs {
     ...
     * Collection of application rule collections used by a Azure Firewall.
     */
    readonly applicationRuleCollections?: pulumi.Input<pulumi.Input<inputs.network.v20180701.AzureFirewallApplicationRuleCollectionArgs>[]>;
    /**
     ...
     * IP configuration of the Azure Firewall resource.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20180701.AzureFirewallIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * Collection of network rule collections used by a Azure Firewall.
     */
    readonly networkRuleCollections?: pulumi.Input<pulumi.Input<inputs.network.v20180701.AzureFirewallNetworkRuleCollectionArgs>[]>;
    /**
