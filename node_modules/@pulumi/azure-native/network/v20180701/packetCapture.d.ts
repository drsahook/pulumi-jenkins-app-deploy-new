...
export declare class PacketCapture extends pulumi.CustomResource {
    ...
    readonly filters: pulumi.Output<outputs.network.v20180701.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    readonly storageLocation: pulumi.Output<outputs.network.v20180701.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
    ...
    readonly filters?: pulumi.Input<pulumi.Input<inputs.network.v20180701.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * Describes the storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Input<inputs.network.v20180701.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
