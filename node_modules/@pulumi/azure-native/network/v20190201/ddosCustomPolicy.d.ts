...
export declare class DdosCustomPolicy extends pulumi.CustomResource {
     ...
     */
    readonly protocolCustomSettings: pulumi.Output<outputs.network.v20190201.ProtocolCustomSettingsFormatResponse[] | undefined>;
    /**
     ...
     */
    readonly publicIPAddresses: pulumi.Output<outputs.network.v20190201.SubResourceResponse[]>;
    /**
...
export interface DdosCustomPolicyArgs {
     ...
     * The protocol-specific DDoS policy customization parameters.
     */
    readonly protocolCustomSettings?: pulumi.Input<pulumi.Input<inputs.network.v20190201.ProtocolCustomSettingsFormatArgs>[]>;
    /**
