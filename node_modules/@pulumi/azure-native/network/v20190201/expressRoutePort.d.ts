...
export declare class ExpressRoutePort extends pulumi.CustomResource {
     ...
     */
    readonly circuits: pulumi.Output<outputs.network.v20190201.SubResourceResponse[]>;
    /**
     ...
     */
    readonly links: pulumi.Output<outputs.network.v20190201.ExpressRouteLinkResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface ExpressRoutePortArgs {
     ...
     * Encapsulation method on physical ports.
     */
    readonly encapsulation?: pulumi.Input<string | enums.network.v20190201.ExpressRoutePortsEncapsulation>;
    /**
     ...
     * The set of physical links of the ExpressRoutePort resource
     */
    readonly links?: pulumi.Input<pulumi.Input<inputs.network.v20190201.ExpressRouteLinkArgs>[]>;
    /**
     * Resource location.
     */
