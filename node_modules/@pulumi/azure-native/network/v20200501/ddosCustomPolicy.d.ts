...
export declare class DdosCustomPolicy extends pulumi.CustomResource {
     ...
     */
    readonly protocolCustomSettings: pulumi.Output<outputs.network.v20200501.ProtocolCustomSettingsFormatResponse[] | undefined>;
    /**
     ...
     */
    readonly publicIPAddresses: pulumi.Output<outputs.network.v20200501.SubResourceResponse[]>;
    /**
...
export interface DdosCustomPolicyArgs {
     ...
     * The protocol-specific DDoS policy customization parameters.
     */
    readonly protocolCustomSettings?: pulumi.Input<pulumi.Input<inputs.network.v20200501.ProtocolCustomSettingsFormatArgs>[]>;
    /**
