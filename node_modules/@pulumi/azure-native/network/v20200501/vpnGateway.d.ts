...
export declare class VpnGateway extends pulumi.CustomResource {
     ...
     */
    readonly connections: pulumi.Output<outputs.network.v20200501.VpnConnectionResponse[] | undefined>;
    /**
...
export interface VpnGatewayArgs {
     ...
     * List of all vpn connections to the gateway.
     */
    readonly connections?: pulumi.Input<pulumi.Input<inputs.network.v20200501.VpnConnectionArgs>[]>;
    /**
