...
export declare class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    readonly autoScaleConfiguration: pulumi.Output<outputs.network.v20200501.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    readonly expressRouteConnections: pulumi.Output<outputs.network.v20200501.ExpressRouteConnectionResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    readonly virtualHub: pulumi.Output<outputs.network.v20200501.VirtualHubIdResponse>;
    /**
...
export interface ExpressRouteGatewayArgs {
     ...
     * Configuration for auto scaling.
     */
    readonly autoScaleConfiguration?: pulumi.Input<inputs.network.v20200501.ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs>;
    /**
     ...
     * The Virtual Hub where the ExpressRoute gateway is or will be deployed.
     */
    readonly virtualHub: pulumi.Input<inputs.network.v20200501.VirtualHubIdArgs>;
}
