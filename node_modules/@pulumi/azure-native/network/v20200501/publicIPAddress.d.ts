...
export declare class PublicIPAddress extends pulumi.CustomResource {
     ...
     */
    readonly ddosSettings: pulumi.Output<outputs.network.v20200501.DdosSettingsResponse | undefined>;
    /**
     * The FQDN of the DNS record associated with the public IP address.
     */
    readonly dnsSettings: pulumi.Output<outputs.network.v20200501.PublicIPAddressDnsSettingsResponse | undefined>;
    /**
     ...
     */
    readonly ipConfiguration: pulumi.Output<outputs.network.v20200501.IPConfigurationResponse>;
    /**
     ...
     */
    readonly publicIPPrefix: pulumi.Output<outputs.network.v20200501.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.network.v20200501.PublicIPAddressSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPAddressArgs {
     ...
     * The DDoS protection custom policy associated with the public IP address.
     */
    readonly ddosSettings?: pulumi.Input<inputs.network.v20200501.DdosSettingsArgs>;
    /**
     * The FQDN of the DNS record associated with the public IP address.
     */
    readonly dnsSettings?: pulumi.Input<inputs.network.v20200501.PublicIPAddressDnsSettingsArgs>;
    /**
     * Resource ID.
     */
     ...
     * The list of tags associated with the public IP address.
     */
    readonly ipTags?: pulumi.Input<pulumi.Input<inputs.network.v20200501.IpTagArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The public IP address version.
     */
    readonly publicIPAddressVersion?: pulumi.Input<string | enums.network.v20200501.IPVersion>;
    /**
     * The public IP address allocation method.
     */
    readonly publicIPAllocationMethod?: pulumi.Input<string | enums.network.v20200501.IPAllocationMethod>;
    /**
     * The Public IP Prefix this Public IP Address should be allocated from.
     */
    readonly publicIPPrefix?: pulumi.Input<inputs.network.v20200501.SubResourceArgs>;
    /**
     ...
     * The public IP address SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.v20200501.PublicIPAddressSkuArgs>;
    /**
     * Resource tags.
     */
