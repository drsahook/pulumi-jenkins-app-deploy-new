...
export declare class ExpressRouteCircuitConnection extends pulumi.CustomResource {
     ...
     */
    readonly expressRouteCircuitPeering: pulumi.Output<outputs.network.v20200501.SubResourceResponse | undefined>;
    /**
     * IPv6 Address PrefixProperties of the express route circuit connection.
     */
    readonly ipv6CircuitConnectionConfig: pulumi.Output<outputs.network.v20200501.Ipv6CircuitConnectionConfigResponse | undefined>;
    /**
     ...
     */
    readonly peerExpressRouteCircuitPeering: pulumi.Output<outputs.network.v20200501.SubResourceResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitConnectionArgs {
     ...
     * Reference to Express Route Circuit Private Peering Resource of the circuit initiating connection.
     */
    readonly expressRouteCircuitPeering?: pulumi.Input<inputs.network.v20200501.SubResourceArgs>;
    /**
     * Resource ID.
     */
     ...
     * IPv6 Address PrefixProperties of the express route circuit connection.
     */
    readonly ipv6CircuitConnectionConfig?: pulumi.Input<inputs.network.v20200501.Ipv6CircuitConnectionConfigArgs>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * Reference to Express Route Circuit Private Peering Resource of the peered circuit.
     */
    readonly peerExpressRouteCircuitPeering?: pulumi.Input<inputs.network.v20200501.SubResourceArgs>;
    /**
