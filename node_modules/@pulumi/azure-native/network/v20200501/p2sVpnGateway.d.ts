...
export interface P2sVpnGatewayArgs {
     ...
     * List of all p2s connection configurations of the gateway.
     */
    readonly p2SConnectionConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20200501.P2SConnectionConfigurationArgs>[]>;
    /**
     ...
     * The VpnServerConfiguration to which the p2sVpnGateway is attached to.
     */
    readonly vpnServerConfiguration?: pulumi.Input<inputs.network.v20200501.SubResourceArgs>;
}
