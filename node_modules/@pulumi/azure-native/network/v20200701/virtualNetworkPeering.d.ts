...
export declare class VirtualNetworkPeering extends pulumi.CustomResource {
     ...
     */
    readonly remoteAddressSpace: pulumi.Output<outputs.network.v20200701.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    readonly remoteBgpCommunities: pulumi.Output<outputs.network.v20200701.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    readonly remoteVirtualNetwork: pulumi.Output<outputs.network.v20200701.SubResourceResponse | undefined>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The status of the virtual network peering.
     */
    readonly peeringState?: pulumi.Input<string | enums.network.v20200701.VirtualNetworkPeeringState>;
    /**
     * The reference to the remote virtual network address space.
     */
    readonly remoteAddressSpace?: pulumi.Input<inputs.network.v20200701.AddressSpaceArgs>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    readonly remoteBgpCommunities?: pulumi.Input<inputs.network.v20200701.VirtualNetworkBgpCommunitiesArgs>;
    /**
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    readonly remoteVirtualNetwork?: pulumi.Input<inputs.network.v20200701.SubResourceArgs>;
    /**
