...
export declare class HubRouteTable extends pulumi.CustomResource {
     ...
     * List of all routes.
     */
    readonly routes: pulumi.Output<outputs.network.v20200701.HubRouteResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface HubRouteTableArgs {
     ...
     * List of all routes.
     */
    readonly routes?: pulumi.Input<pulumi.Input<inputs.network.v20200701.HubRouteArgs>[]>;
    /**
