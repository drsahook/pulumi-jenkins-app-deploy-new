...
export declare class VirtualHubRouteTableV2 extends pulumi.CustomResource {
     ...
     * List of all routes.
     */
    readonly routes: pulumi.Output<outputs.network.v20200701.VirtualHubRouteV2Response[] | undefined>;
    /**
...
export interface VirtualHubRouteTableV2Args {
     ...
     * List of all routes.
     */
    readonly routes?: pulumi.Input<pulumi.Input<inputs.network.v20200701.VirtualHubRouteV2Args>[]>;
    /**
