...
export declare class VirtualNetworkTap extends pulumi.CustomResource {
     ...
     */
    readonly destinationLoadBalancerFrontEndIPConfiguration: pulumi.Output<outputs.network.v20200701.FrontendIPConfigurationResponse | undefined>;
    /**
     * The reference to the private IP Address of the collector nic that will receive the tap.
     */
    readonly destinationNetworkInterfaceIPConfiguration: pulumi.Output<outputs.network.v20200701.NetworkInterfaceIPConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly networkInterfaceTapConfigurations: pulumi.Output<outputs.network.v20200701.NetworkInterfaceTapConfigurationResponse[]>;
    /**
...
export interface VirtualNetworkTapArgs {
     ...
     * The reference to the private IP address on the internal Load Balancer that will receive the tap.
     */
    readonly destinationLoadBalancerFrontEndIPConfiguration?: pulumi.Input<inputs.network.v20200701.FrontendIPConfigurationArgs>;
    /**
     * The reference to the private IP Address of the collector nic that will receive the tap.
     */
    readonly destinationNetworkInterfaceIPConfiguration?: pulumi.Input<inputs.network.v20200701.NetworkInterfaceIPConfigurationArgs>;
    /**
     * The VXLAN destination port that will receive the tapped traffic.
     */
