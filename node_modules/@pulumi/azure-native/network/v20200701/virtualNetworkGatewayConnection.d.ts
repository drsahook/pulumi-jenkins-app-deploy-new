...
export declare class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
     ...
     */
    readonly ipsecPolicies: pulumi.Output<outputs.network.v20200701.IpsecPolicyResponse[] | undefined>;
    /**
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2: pulumi.Output<outputs.network.v20200701.LocalNetworkGatewayResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly peer: pulumi.Output<outputs.network.v20200701.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly trafficSelectorPolicies: pulumi.Output<outputs.network.v20200701.TrafficSelectorPolicyResponse[] | undefined>;
    /**
     * Collection of all tunnels' connection health status.
     */
    readonly tunnelConnectionStatus: pulumi.Output<outputs.network.v20200701.TunnelConnectionHealthResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    readonly virtualNetworkGateway1: pulumi.Output<outputs.network.v20200701.VirtualNetworkGatewayResponse>;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2: pulumi.Output<outputs.network.v20200701.VirtualNetworkGatewayResponse | undefined>;
    /**
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * The connection mode for this connection.
     */
    readonly connectionMode?: pulumi.Input<string | enums.network.v20200701.VirtualNetworkGatewayConnectionMode>;
    /**
     * Connection protocol used for this connection.
     */
    readonly connectionProtocol?: pulumi.Input<string | enums.network.v20200701.VirtualNetworkGatewayConnectionProtocol>;
    /**
     * Gateway connection type.
     */
    readonly connectionType: pulumi.Input<string | enums.network.v20200701.VirtualNetworkGatewayConnectionType>;
    /**
     * The dead peer detection timeout of this connection in seconds.
     */
     ...
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2?: pulumi.Input<inputs.network.v20200701.LocalNetworkGatewayArgs>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    readonly peer?: pulumi.Input<inputs.network.v20200701.SubResourceArgs>;
    /**
     ...
     * The Traffic Selector Policies to be considered by this connection.
     */
    readonly trafficSelectorPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20200701.TrafficSelectorPolicyArgs>[]>;
    /**
     * Use private local Azure IP for the connection.
     */
     ...
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway1: pulumi.Input<inputs.network.v20200701.VirtualNetworkGatewayArgs>;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2?: pulumi.Input<inputs.network.v20200701.VirtualNetworkGatewayArgs>;
    /**
