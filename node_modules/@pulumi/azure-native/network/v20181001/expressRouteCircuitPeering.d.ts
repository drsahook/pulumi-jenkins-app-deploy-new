...
export declare class ExpressRouteCircuitPeering extends pulumi.CustomResource {
     ...
     */
    readonly connections: pulumi.Output<outputs.network.v20181001.ExpressRouteCircuitConnectionResponse[] | undefined>;
    /**
     ...
     */
    readonly expressRouteConnection: pulumi.Output<outputs.network.v20181001.ExpressRouteConnectionIdResponse | undefined>;
    /**
     ...
     */
    readonly ipv6PeeringConfig: pulumi.Output<outputs.network.v20181001.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly microsoftPeeringConfig: pulumi.Output<outputs.network.v20181001.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly routeFilter: pulumi.Output<outputs.network.v20181001.RouteFilterResponse | undefined>;
    /**
     * The secondary port.
     */
     ...
     * Gets peering stats.
     */
    readonly stats: pulumi.Output<outputs.network.v20181001.ExpressRouteCircuitStatsResponse | undefined>;
    /**
     * The VLAN ID.
     */
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * The list of circuit connections associated with Azure Private Peering for this circuit.
     */
    readonly connections?: pulumi.Input<pulumi.Input<inputs.network.v20181001.ExpressRouteCircuitConnectionArgs>[]>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The IPv6 peering configuration.
     */
    readonly ipv6PeeringConfig?: pulumi.Input<inputs.network.v20181001.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets whether the provider or the customer last modified the peering.
     */
     ...
     * The Microsoft peering configuration.
     */
    readonly microsoftPeeringConfig?: pulumi.Input<inputs.network.v20181001.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The peering type.
     */
    readonly peeringType?: pulumi.Input<string | enums.network.v20181001.ExpressRoutePeeringType>;
    /**
     * The primary port.
     */
     ...
     * The reference of the RouteFilter resource.
     */
    readonly routeFilter?: pulumi.Input<inputs.network.v20181001.RouteFilterArgs>;
    /**
     * The secondary port.
     */
     ...
     * The peering state.
     */
    readonly state?: pulumi.Input<string | enums.network.v20181001.ExpressRoutePeeringState>;
    /**
     * Gets peering stats.
     */
    readonly stats?: pulumi.Input<inputs.network.v20181001.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */
