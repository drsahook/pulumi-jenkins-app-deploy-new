...
export declare class VpnGateway extends pulumi.CustomResource {
     ...
     */
    readonly connections: pulumi.Output<outputs.network.v20181001.VpnConnectionResponse[] | undefined>;
    /**
...
export interface VpnGatewayArgs {
     ...
     * list of all vpn connections to the gateway.
     */
    readonly connections?: pulumi.Input<pulumi.Input<inputs.network.v20181001.VpnConnectionArgs>[]>;
    /**
