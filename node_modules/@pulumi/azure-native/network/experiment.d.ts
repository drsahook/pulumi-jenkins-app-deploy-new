...
export declare class Experiment extends pulumi.CustomResource {
     ...
     */
    readonly endpointA: pulumi.Output<outputs.network.ExperimentEndpointResponse | undefined>;
    /**
     * The endpoint B of an experiment
     */
    readonly endpointB: pulumi.Output<outputs.network.ExperimentEndpointResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface ExperimentArgs {
     ...
     * The state of the Experiment
     */
    readonly enabledState?: pulumi.Input<string | enums.network.State>;
    /**
     * The endpoint A of an experiment
     */
