...
export declare class PacketCapture extends pulumi.CustomResource {
    ...
    readonly filters: pulumi.Output<outputs.network.v20181101.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    readonly storageLocation: pulumi.Output<outputs.network.v20181101.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
    ...
    readonly filters?: pulumi.Input<pulumi.Input<inputs.network.v20181101.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * Describes the storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Input<inputs.network.v20181101.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
