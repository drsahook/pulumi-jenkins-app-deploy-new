...
export declare class P2sVpnGateway extends pulumi.CustomResource {
     ...
     */
    readonly p2SVpnServerConfiguration: pulumi.Output<outputs.network.v20181101.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly virtualHub: pulumi.Output<outputs.network.v20181101.SubResourceResponse | undefined>;
    /**
     * The reference of the address space resource which represents Address space for P2S VpnClient.
     */
    readonly vpnClientAddressPool: pulumi.Output<outputs.network.v20181101.AddressSpaceResponse | undefined>;
    /**
     * All P2S VPN clients' connection health status.
     */
    readonly vpnClientConnectionHealth: pulumi.Output<outputs.network.v20181101.VpnClientConnectionHealthResponse>;
    /**
...
export interface P2sVpnGatewayArgs {
     ...
     * The P2SVpnServerConfiguration to which the p2sVpnGateway is attached to.
     */
    readonly p2SVpnServerConfiguration?: pulumi.Input<inputs.network.v20181101.SubResourceArgs>;
    /**
     ...
     * The VirtualHub to which the gateway belongs
     */
    readonly virtualHub?: pulumi.Input<inputs.network.v20181101.SubResourceArgs>;
    /**
     * The reference of the address space resource which represents Address space for P2S VpnClient.
     */
    readonly vpnClientAddressPool?: pulumi.Input<inputs.network.v20181101.AddressSpaceArgs>;
    /**
     * The scale unit for this p2s vpn gateway.
     */
