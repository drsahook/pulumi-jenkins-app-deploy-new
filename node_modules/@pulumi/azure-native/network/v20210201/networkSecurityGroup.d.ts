...
export declare class NetworkSecurityGroup extends pulumi.CustomResource {
     ...
     */
    readonly defaultSecurityRules: pulumi.Output<outputs.network.v20210201.SecurityRuleResponse[]>;
    /**
     ...
     */
    readonly flowLogs: pulumi.Output<outputs.network.v20210201.FlowLogResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    readonly securityRules: pulumi.Output<outputs.network.v20210201.SecurityRuleResponse[] | undefined>;
    /**
     * A collection of references to subnets.
     */
    readonly subnets: pulumi.Output<outputs.network.v20210201.SubnetResponse[]>;
    /**
     * Resource tags.
     */
...
export interface NetworkSecurityGroupArgs {
     ...
     * A collection of security rules of the network security group.
     */
    readonly securityRules?: pulumi.Input<pulumi.Input<inputs.network.v20210201.SecurityRuleArgs>[]>;
    /**
     * Resource tags.
     */
