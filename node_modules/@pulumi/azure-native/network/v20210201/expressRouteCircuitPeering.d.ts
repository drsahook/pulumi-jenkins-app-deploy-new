...
export declare class ExpressRouteCircuitPeering extends pulumi.CustomResource {
     ...
     */
    readonly connections: pulumi.Output<outputs.network.v20210201.ExpressRouteCircuitConnectionResponse[] | undefined>;
    /**
     ...
     */
    readonly expressRouteConnection: pulumi.Output<outputs.network.v20210201.ExpressRouteConnectionIdResponse | undefined>;
    /**
     ...
     */
    readonly ipv6PeeringConfig: pulumi.Output<outputs.network.v20210201.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly microsoftPeeringConfig: pulumi.Output<outputs.network.v20210201.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly peeredConnections: pulumi.Output<outputs.network.v20210201.PeerExpressRouteCircuitConnectionResponse[]>;
    /**
     * The peering type.
     */
     ...
     */
    readonly routeFilter: pulumi.Output<outputs.network.v20210201.SubResourceResponse | undefined>;
    /**
     * The secondary port.
     */
     ...
     */
    readonly stats: pulumi.Output<outputs.network.v20210201.ExpressRouteCircuitStatsResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * The list of circuit connections associated with Azure Private Peering for this circuit.
     */
    readonly connections?: pulumi.Input<pulumi.Input<inputs.network.v20210201.ExpressRouteCircuitConnectionArgs>[]>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The reference to the RouteFilter resource.
     */
    readonly routeFilter?: pulumi.Input<inputs.network.v20210201.SubResourceArgs>;
    /**
     * The secondary port.
     */
     ...
     * The peering stats of express route circuit.
     */
    readonly stats?: pulumi.Input<inputs.network.v20210201.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */
