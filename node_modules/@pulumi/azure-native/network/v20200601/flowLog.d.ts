...
export interface FlowLogArgs {
     ...
     * Parameters that define the configuration of traffic analytics.
     */
    readonly flowAnalyticsConfiguration?: pulumi.Input<inputs.network.v20200601.TrafficAnalyticsPropertiesArgs>;
    /**
     ...
     * Parameters that define the flow log format.
     */
    readonly format?: pulumi.Input<inputs.network.v20200601.FlowLogFormatParametersArgs>;
    /**
     * Resource ID.
     */
     ...
     * Parameters that define the retention policy for flow log.
     */
    readonly retentionPolicy?: pulumi.Input<inputs.network.v20200601.RetentionPolicyParametersArgs>;
    /**
     * ID of the storage account which is used to store the flow log.
     */
