...
export declare class RulesEngine extends pulumi.CustomResource {
     ...
     */
    readonly rules: pulumi.Output<outputs.network.v20200401.RulesEngineRuleResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface RulesEngineArgs {
     ...
     * A list of rules that define a particular Rules Engine Configuration.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.network.v20200401.RulesEngineRuleArgs>[]>;
    /**
