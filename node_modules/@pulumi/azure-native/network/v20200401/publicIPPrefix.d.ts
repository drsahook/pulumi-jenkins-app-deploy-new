...
export declare class PublicIPPrefix extends pulumi.CustomResource {
     ...
     */
    readonly loadBalancerFrontendIpConfiguration: pulumi.Output<outputs.network.v20200401.SubResourceResponse>;
    /**
     * Resource location.
     */
     ...
     */
    readonly publicIPAddresses: pulumi.Output<outputs.network.v20200401.ReferencedPublicIpAddressResponse[]>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.network.v20200401.PublicIPPrefixSkuResponse | undefined>;
    /**
     * Resource tags.
     */
