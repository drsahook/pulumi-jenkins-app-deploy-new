...
export declare class PacketCapture extends pulumi.CustomResource {
     ...
     */
    readonly filters: pulumi.Output<outputs.network.v20200401.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    readonly storageLocation: pulumi.Output<outputs.network.v20200401.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
     ...
     * A list of packet capture filters.
     */
    readonly filters?: pulumi.Input<pulumi.Input<inputs.network.v20200401.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * The storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Input<inputs.network.v20200401.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
