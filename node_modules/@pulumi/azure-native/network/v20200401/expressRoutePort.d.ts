...
export declare class ExpressRoutePort extends pulumi.CustomResource {
     ...
     */
    readonly circuits: pulumi.Output<outputs.network.v20200401.SubResourceResponse[]>;
    /**
     ...
     */
    readonly links: pulumi.Output<outputs.network.v20200401.ExpressRouteLinkResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface ExpressRoutePortArgs {
     ...
     * Encapsulation method on physical ports.
     */
    readonly encapsulation?: pulumi.Input<string | enums.network.v20200401.ExpressRoutePortsEncapsulation>;
    /**
     ...
     * The set of physical links of the ExpressRoutePort resource.
     */
    readonly links?: pulumi.Input<pulumi.Input<inputs.network.v20200401.ExpressRouteLinkArgs>[]>;
    /**
     * Resource location.
     */
