...
export interface GetApplicationGatewayBackendHealthOnDemandArgs {
     ...
     */
    readonly backendAddressPool?: inputs.network.v20200401.SubResource;
    /**
     * Reference to backend http setting of application gateway to be used for test probe.
     */
    readonly backendHttpSettings?: inputs.network.v20200401.SubResource;
    /**
     ...
     */
    readonly match?: inputs.network.v20200401.ApplicationGatewayProbeHealthResponseMatch;
    /**
     ...
     */
    readonly protocol?: string | enums.network.v20200401.ApplicationGatewayProtocol;
    /**
