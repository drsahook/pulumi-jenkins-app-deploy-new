...
export declare class RouteFilter extends pulumi.CustomResource {
     ...
     */
    readonly ipv6Peerings: pulumi.Output<outputs.network.v20200401.ExpressRouteCircuitPeeringResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    readonly peerings: pulumi.Output<outputs.network.v20200401.ExpressRouteCircuitPeeringResponse[]>;
    /**
     ...
     */
    readonly rules: pulumi.Output<outputs.network.v20200401.RouteFilterRuleResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterArgs {
     ...
     * Collection of RouteFilterRules contained within a route filter.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.network.v20200401.RouteFilterRuleArgs>[]>;
    /**
     * Resource tags.
     */
