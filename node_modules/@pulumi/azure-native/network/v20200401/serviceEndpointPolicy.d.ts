...
export declare class ServiceEndpointPolicy extends pulumi.CustomResource {
     ...
     */
    readonly serviceEndpointPolicyDefinitions: pulumi.Output<outputs.network.v20200401.ServiceEndpointPolicyDefinitionResponse[] | undefined>;
    /**
...
export interface ServiceEndpointPolicyArgs {
     ...
     * A collection of service endpoint policy definitions of the service endpoint policy.
     */
    readonly serviceEndpointPolicyDefinitions?: pulumi.Input<pulumi.Input<inputs.network.v20200401.ServiceEndpointPolicyDefinitionArgs>[]>;
    /**
