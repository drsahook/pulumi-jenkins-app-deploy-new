...
export declare class P2sVpnGateway extends pulumi.CustomResource {
     ...
     */
    readonly p2SConnectionConfigurations: pulumi.Output<outputs.network.v20200401.P2SConnectionConfigurationResponse[] | undefined>;
    /**
     ...
     */
    readonly vpnClientConnectionHealth: pulumi.Output<outputs.network.v20200401.VpnClientConnectionHealthResponse>;
    /**
     ...
     */
    readonly vpnServerConfiguration: pulumi.Output<outputs.network.v20200401.SubResourceResponse | undefined>;
    /**
...
export interface P2sVpnGatewayArgs {
     ...
     * List of all p2s connection configurations of the gateway.
     */
    readonly p2SConnectionConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20200401.P2SConnectionConfigurationArgs>[]>;
    /**
     ...
     * The VpnServerConfiguration to which the p2sVpnGateway is attached to.
     */
    readonly vpnServerConfiguration?: pulumi.Input<inputs.network.v20200401.SubResourceArgs>;
}
