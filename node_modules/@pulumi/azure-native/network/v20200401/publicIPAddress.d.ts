...
export declare class PublicIPAddress extends pulumi.CustomResource {
     ...
     */
    readonly ddosSettings: pulumi.Output<outputs.network.v20200401.DdosSettingsResponse | undefined>;
    /**
     * The FQDN of the DNS record associated with the public IP address.
     */
    readonly dnsSettings: pulumi.Output<outputs.network.v20200401.PublicIPAddressDnsSettingsResponse | undefined>;
    /**
     ...
     */
    readonly ipConfiguration: pulumi.Output<outputs.network.v20200401.IPConfigurationResponse>;
    /**
     * The list of tags associated with the public IP address.
     */
    readonly ipTags: pulumi.Output<outputs.network.v20200401.IpTagResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly publicIPPrefix: pulumi.Output<outputs.network.v20200401.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.network.v20200401.PublicIPAddressSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPAddressArgs {
     ...
     * The DDoS protection custom policy associated with the public IP address.
     */
    readonly ddosSettings?: pulumi.Input<inputs.network.v20200401.DdosSettingsArgs>;
    /**
     * The FQDN of the DNS record associated with the public IP address.
     */
    readonly dnsSettings?: pulumi.Input<inputs.network.v20200401.PublicIPAddressDnsSettingsArgs>;
    /**
     * Resource ID.
     */
     ...
     * The Public IP Prefix this Public IP Address should be allocated from.
     */
    readonly publicIPPrefix?: pulumi.Input<inputs.network.v20200401.SubResourceArgs>;
    /**
     ...
     * The public IP address SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.v20200401.PublicIPAddressSkuArgs>;
    /**
     * Resource tags.
     */
