...
export declare class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly virtualNetworkTap: pulumi.Output<outputs.network.v20200401.VirtualNetworkTapResponse | undefined>;
    /**
...
export interface NetworkInterfaceTapConfigurationArgs {
     ...
     * The reference to the Virtual Network Tap resource.
     */
    readonly virtualNetworkTap?: pulumi.Input<inputs.network.v20200401.VirtualNetworkTapArgs>;
}
