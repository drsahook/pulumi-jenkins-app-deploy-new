...
export declare class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
     ...
     */
    readonly backendIPConfigurations: pulumi.Output<outputs.network.v20200401.NetworkInterfaceIPConfigurationResponse[]>;
    /**
     ...
     */
    readonly loadBalancerBackendAddresses: pulumi.Output<outputs.network.v20200401.LoadBalancerBackendAddressResponse[] | undefined>;
    /**
     * An array of references to load balancing rules that use this backend address pool.
     */
    readonly loadBalancingRules: pulumi.Output<outputs.network.v20200401.SubResourceResponse[]>;
    /**
     ...
     */
    readonly outboundRule: pulumi.Output<outputs.network.v20200401.SubResourceResponse>;
    /**
     * An array of references to outbound rules that use this backend address pool.
     */
    readonly outboundRules: pulumi.Output<outputs.network.v20200401.SubResourceResponse[]>;
    /**
