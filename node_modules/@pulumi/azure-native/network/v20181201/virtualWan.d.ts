...
export declare class VirtualWan extends pulumi.CustomResource {
     ...
     */
    readonly p2SVpnServerConfigurations: pulumi.Output<outputs.network.v20181201.P2SVpnServerConfigurationResponse[] | undefined>;
    /**
     ...
     */
    readonly virtualHubs: pulumi.Output<outputs.network.v20181201.SubResourceResponse[]>;
    readonly vpnSites: pulumi.Output<outputs.network.v20181201.SubResourceResponse[]>;
    /**
...
export interface VirtualWanArgs {
     ...
     * List of all P2SVpnServerConfigurations associated with the virtual wan.
     */
    readonly p2SVpnServerConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20181201.P2SVpnServerConfigurationArgs>[]>;
    /**
