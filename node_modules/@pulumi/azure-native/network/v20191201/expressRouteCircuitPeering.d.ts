...
export declare class ExpressRouteCircuitPeering extends pulumi.CustomResource {
     ...
     */
    readonly connections: pulumi.Output<outputs.network.v20191201.ExpressRouteCircuitConnectionResponse[] | undefined>;
    /**
     ...
     */
    readonly expressRouteConnection: pulumi.Output<outputs.network.v20191201.ExpressRouteConnectionIdResponse | undefined>;
    /**
     ...
     */
    readonly peeredConnections: pulumi.Output<outputs.network.v20191201.PeerExpressRouteCircuitConnectionResponse[]>;
    /**
     * The peering type.
     */
     ...
     */
    readonly routeFilter: pulumi.Output<outputs.network.v20191201.SubResourceResponse | undefined>;
    /**
     * The secondary port.
     */
     ...
     */
    readonly stats: pulumi.Output<outputs.network.v20191201.ExpressRouteCircuitStatsResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * The list of circuit connections associated with Azure Private Peering for this circuit.
     */
    readonly connections?: pulumi.Input<pulumi.Input<inputs.network.v20191201.ExpressRouteCircuitConnectionArgs>[]>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The IPv6 peering configuration.
     */
    readonly ipv6PeeringConfig?: pulumi.Input<inputs.network.v20191201.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * The Microsoft peering configuration.
     */
    readonly microsoftPeeringConfig?: pulumi.Input<inputs.network.v20191201.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The peering type.
     */
    readonly peeringType?: pulumi.Input<string | enums.network.v20191201.ExpressRoutePeeringType>;
    /**
     * The primary port.
     */
     ...
     * The reference to the RouteFilter resource.
     */
    readonly routeFilter?: pulumi.Input<inputs.network.v20191201.SubResourceArgs>;
    /**
     * The secondary port.
     */
     ...
     * The peering state.
     */
    readonly state?: pulumi.Input<string | enums.network.v20191201.ExpressRoutePeeringState>;
    /**
     * The peering stats of express route circuit.
     */
    readonly stats?: pulumi.Input<inputs.network.v20191201.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */
