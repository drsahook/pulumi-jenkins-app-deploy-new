...
export declare class SecurityRule extends pulumi.CustomResource {
     ...
     */
    readonly destinationApplicationSecurityGroups: pulumi.Output<outputs.network.v20191201.ApplicationSecurityGroupResponse[] | undefined>;
    /**
     ...
     */
    readonly sourceApplicationSecurityGroups: pulumi.Output<outputs.network.v20191201.ApplicationSecurityGroupResponse[] | undefined>;
    /**
...
export interface SecurityRuleArgs {
     ...
     * The network traffic is allowed or denied.
     */
    readonly access: pulumi.Input<string | enums.network.v20191201.SecurityRuleAccess>;
    /**
     * A description for this rule. Restricted to 140 chars.
     */
     ...
     * The application security group specified as destination.
     */
    readonly destinationApplicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.network.v20191201.ApplicationSecurityGroupArgs>[]>;
    /**
     * The destination port or range. Integer or range between 0 and 65535. Asterisk '*' can also be used to match all ports.
     */
     ...
     * The direction of the rule. The direction specifies if rule will be evaluated on incoming or outgoing traffic.
     */
    readonly direction: pulumi.Input<string | enums.network.v20191201.SecurityRuleDirection>;
    /**
     * Resource ID.
     */
     ...
     * Network protocol this rule applies to.
     */
    readonly protocol: pulumi.Input<string | enums.network.v20191201.SecurityRuleProtocol>;
    /**
     ...
     * The application security group specified as source.
     */
    readonly sourceApplicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.network.v20191201.ApplicationSecurityGroupArgs>[]>;
    /**
     * The source port or range. Integer or range between 0 and 65535. Asterisk '*' can also be used to match all ports.
     */
