...
export interface WebApplicationFirewallPolicyArgs {
     ...
     * The custom rules inside the policy.
     */
    readonly customRules?: pulumi.Input<pulumi.Input<inputs.network.v20191201.WebApplicationFirewallCustomRuleArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Describes the managedRules structure.
     */
    readonly managedRules: pulumi.Input<inputs.network.v20191201.ManagedRulesDefinitionArgs>;
    /**
     ...
     * The PolicySettings for policy.
     */
    readonly policySettings?: pulumi.Input<inputs.network.v20191201.PolicySettingsArgs>;
    /**
