...
export declare class VpnGateway extends pulumi.CustomResource {
     ...
     */
    readonly connections: pulumi.Output<outputs.network.v20191201.VpnConnectionResponse[] | undefined>;
    /**
...
export interface VpnGatewayArgs {
     ...
     * List of all vpn connections to the gateway.
     */
    readonly connections?: pulumi.Input<pulumi.Input<inputs.network.v20191201.VpnConnectionArgs>[]>;
    /**
