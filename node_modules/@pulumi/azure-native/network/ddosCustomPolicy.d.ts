...
export declare class DdosCustomPolicy extends pulumi.CustomResource {
     ...
     */
    readonly protocolCustomSettings: pulumi.Output<outputs.network.ProtocolCustomSettingsFormatResponse[] | undefined>;
    /**
...
export interface DdosCustomPolicyArgs {
     ...
     * The protocol-specific DDoS policy customization parameters.
     */
    readonly protocolCustomSettings?: pulumi.Input<pulumi.Input<inputs.network.ProtocolCustomSettingsFormatArgs>[]>;
    /**
