...
export declare class PrivateLinkServicePrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.network.v20191101.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
...
export interface PrivateLinkServicePrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.network.v20191101.PrivateLinkServiceConnectionStateArgs>;
    /**
