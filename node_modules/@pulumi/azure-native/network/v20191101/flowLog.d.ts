...
export declare class FlowLog extends pulumi.CustomResource {
     ...
     */
    readonly flowAnalyticsConfiguration: pulumi.Output<outputs.network.v20191101.TrafficAnalyticsPropertiesResponse | undefined>;
    /**
     * Parameters that define the flow log format.
     */
    readonly format: pulumi.Output<outputs.network.v20191101.FlowLogFormatParametersResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly retentionPolicy: pulumi.Output<outputs.network.v20191101.RetentionPolicyParametersResponse | undefined>;
    /**
...
export interface FlowLogArgs {
     ...
     * Parameters that define the configuration of traffic analytics.
     */
    readonly flowAnalyticsConfiguration?: pulumi.Input<inputs.network.v20191101.TrafficAnalyticsPropertiesArgs>;
    /**
     ...
     * Parameters that define the flow log format.
     */
    readonly format?: pulumi.Input<inputs.network.v20191101.FlowLogFormatParametersArgs>;
    /**
     * Resource ID.
     */
     ...
     * Parameters that define the retention policy for flow log.
     */
    readonly retentionPolicy?: pulumi.Input<inputs.network.v20191101.RetentionPolicyParametersArgs>;
    /**
     * ID of the storage account which is used to store the flow log.
     */
