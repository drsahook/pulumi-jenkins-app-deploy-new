...
export declare class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    readonly autoScaleConfiguration: pulumi.Output<outputs.network.v20190401.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    readonly expressRouteConnections: pulumi.Output<outputs.network.v20190401.ExpressRouteConnectionResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    readonly virtualHub: pulumi.Output<outputs.network.v20190401.VirtualHubIdResponse>;
    /**
