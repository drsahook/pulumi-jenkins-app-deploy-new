...
export interface P2sVpnServerConfigurationArgs {
     ...
     * Radius client root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigRadiusClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20190401.P2SVpnServerConfigRadiusClientRootCertificateArgs>[]>;
    /**
     * Radius Server root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigRadiusServerRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20190401.P2SVpnServerConfigRadiusServerRootCertificateArgs>[]>;
    /**
     * VPN client revoked certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigVpnClientRevokedCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20190401.P2SVpnServerConfigVpnClientRevokedCertificateArgs>[]>;
    /**
     * VPN client root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigVpnClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20190401.P2SVpnServerConfigVpnClientRootCertificateArgs>[]>;
    /**
     ...
     * VpnClientIpsecPolicies for P2SVpnServerConfiguration.
     */
    readonly vpnClientIpsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20190401.IpsecPolicyArgs>[]>;
    /**
     * VPN protocols for the P2SVpnServerConfiguration.
     */
    readonly vpnProtocols?: pulumi.Input<pulumi.Input<string | enums.network.v20190401.VpnGatewayTunnelingProtocol>[]>;
}
