...
export interface P2sVpnGatewayArgs {
     ...
     * The P2SVpnServerConfiguration to which the p2sVpnGateway is attached to.
     */
    readonly p2SVpnServerConfiguration?: pulumi.Input<inputs.network.v20190701.SubResourceArgs>;
    /**
     ...
     * The reference of the address space resource which represents Address space for P2S VpnClient.
     */
    readonly vpnClientAddressPool?: pulumi.Input<inputs.network.v20190701.AddressSpaceArgs>;
    /**
     * The scale unit for this p2s vpn gateway.
     */
