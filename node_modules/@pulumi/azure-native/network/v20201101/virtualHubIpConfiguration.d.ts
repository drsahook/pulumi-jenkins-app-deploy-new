...
export declare class VirtualHubIpConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly publicIPAddress: pulumi.Output<outputs.network.v20201101.PublicIPAddressResponse | undefined>;
    /**
...
export interface VirtualHubIpConfigurationArgs {
     ...
     * The private IP address allocation method.
     */
    readonly privateIPAllocationMethod?: pulumi.Input<string | enums.network.v20201101.IPAllocationMethod>;
    /**
     * The reference to the public IP resource.
     */
    readonly publicIPAddress?: pulumi.Input<inputs.network.v20201101.PublicIPAddressArgs>;
    /**
