...
export declare class VirtualWan extends pulumi.CustomResource {
     ...
     */
    readonly p2SVpnServerConfigurations: pulumi.Output<outputs.network.v20180801.P2SVpnServerConfigurationResponse[] | undefined>;
    /**
     ...
     */
    readonly virtualHubs: pulumi.Output<outputs.network.v20180801.SubResourceResponse[]>;
    readonly vpnSites: pulumi.Output<outputs.network.v20180801.SubResourceResponse[]>;
    /**
...
export interface VirtualWanArgs {
     ...
     * list of all P2SVpnServerConfigurations associated with the virtual wan.
     */
    readonly p2SVpnServerConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20180801.P2SVpnServerConfigurationArgs>[]>;
    /**
