...
export interface VirtualNetworkGatewayArgs {
     ...
     * The reference of the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
     */
    readonly gatewayDefaultSite?: pulumi.Input<inputs.network.v20180101.SubResourceArgs>;
    /**
     * The type of this virtual network gateway. Possible values are: 'Vpn' and 'ExpressRoute'.
     */
    readonly gatewayType?: pulumi.Input<string | enums.network.v20180101.VirtualNetworkGatewayType>;
    /**
     * Resource ID.
     */
     ...
     * IP configurations for virtual network gateway.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20180101.VirtualNetworkGatewayIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The reference of the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
     */
    readonly sku?: pulumi.Input<inputs.network.v20180101.VirtualNetworkGatewaySkuArgs>;
    /**
     * Resource tags.
     */
     ...
     * The reference of the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    readonly vpnClientConfiguration?: pulumi.Input<inputs.network.v20180101.VpnClientConfigurationArgs>;
    /**
     * The type of this virtual network gateway. Possible values are: 'PolicyBased' and 'RouteBased'.
     */
    readonly vpnType?: pulumi.Input<string | enums.network.v20180101.VpnType>;
}
