...
export interface SubnetArgs {
     ...
     * Gets an array of references to the external resources using subnet.
     */
    readonly resourceNavigationLinks?: pulumi.Input<pulumi.Input<inputs.network.v20170901.ResourceNavigationLinkArgs>[]>;
    /**
     * The reference of the RouteTable resource.
     */
    readonly routeTable?: pulumi.Input<inputs.network.v20170901.RouteTableArgs>;
    /**
     * An array of service endpoints.
     */
    readonly serviceEndpoints?: pulumi.Input<pulumi.Input<inputs.network.v20170901.ServiceEndpointPropertiesFormatArgs>[]>;
    /**
