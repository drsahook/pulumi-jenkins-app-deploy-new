...
export declare class CustomIPPrefix extends pulumi.CustomResource {
     ...
     */
    readonly publicIpPrefixes: pulumi.Output<outputs.network.v20200801.SubResourceResponse[]>;
    /**
...
export interface CustomIPPrefixArgs {
     ...
     * The commissioned state of the Custom IP Prefix.
     */
    readonly commissionedState?: pulumi.Input<string | enums.network.v20200801.CommissionedState>;
    /**
