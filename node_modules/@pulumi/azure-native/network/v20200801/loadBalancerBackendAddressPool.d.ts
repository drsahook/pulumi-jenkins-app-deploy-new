...
export declare class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
     ...
     */
    readonly backendIPConfigurations: pulumi.Output<outputs.network.v20200801.NetworkInterfaceIPConfigurationResponse[]>;
    /**
     ...
     */
    readonly loadBalancerBackendAddresses: pulumi.Output<outputs.network.v20200801.LoadBalancerBackendAddressResponse[] | undefined>;
    /**
     * An array of references to load balancing rules that use this backend address pool.
     */
    readonly loadBalancingRules: pulumi.Output<outputs.network.v20200801.SubResourceResponse[]>;
    /**
     ...
     */
    readonly outboundRule: pulumi.Output<outputs.network.v20200801.SubResourceResponse>;
    /**
     * An array of references to outbound rules that use this backend address pool.
     */
    readonly outboundRules: pulumi.Output<outputs.network.v20200801.SubResourceResponse[]>;
    /**
...
export interface LoadBalancerBackendAddressPoolArgs {
     ...
     * An array of backend addresses.
     */
    readonly loadBalancerBackendAddresses?: pulumi.Input<pulumi.Input<inputs.network.v20200801.LoadBalancerBackendAddressArgs>[]>;
    /**
