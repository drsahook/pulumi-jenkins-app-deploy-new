...
export declare class PublicIPAddress extends pulumi.CustomResource {
     ...
     */
    readonly ddosSettings: pulumi.Output<outputs.network.v20200801.DdosSettingsResponse | undefined>;
    /**
     * The FQDN of the DNS record associated with the public IP address.
     */
    readonly dnsSettings: pulumi.Output<outputs.network.v20200801.PublicIPAddressDnsSettingsResponse | undefined>;
    /**
     ...
     */
    readonly ipConfiguration: pulumi.Output<outputs.network.v20200801.IPConfigurationResponse>;
    /**
     * The list of tags associated with the public IP address.
     */
    readonly ipTags: pulumi.Output<outputs.network.v20200801.IpTagResponse[] | undefined>;
    /**
     * The source Public IP Address (IPv6) that links to this address (IPv4).
     */
    readonly linkedPublicIPAddress: pulumi.Output<outputs.network.v20200801.PublicIPAddressResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly natGateway: pulumi.Output<outputs.network.v20200801.NatGatewayResponse | undefined>;
    /**
     ...
     */
    readonly publicIPPrefix: pulumi.Output<outputs.network.v20200801.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly servicePublicIPAddress: pulumi.Output<outputs.network.v20200801.PublicIPAddressResponse | undefined>;
    /**
     * The public IP address SKU.
     */
    readonly sku: pulumi.Output<outputs.network.v20200801.PublicIPAddressSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPAddressArgs {
     ...
     * Migration phase of Public IP Address.
     */
    readonly migrationPhase?: pulumi.Input<string | enums.network.v20200801.PublicIpAddressMigrationPhase>;
    /**
     * The NatGateway for the Public IP address.
     */
     ...
     * The public IP address allocation method.
     */
    readonly publicIPAllocationMethod?: pulumi.Input<string | enums.network.v20200801.IPAllocationMethod>;
    /**
     * The Public IP Prefix this Public IP Address should be allocated from.
     */
