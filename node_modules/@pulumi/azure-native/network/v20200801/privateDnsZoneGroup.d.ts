...
export declare class PrivateDnsZoneGroup extends pulumi.CustomResource {
     ...
     */
    readonly privateDnsZoneConfigs: pulumi.Output<outputs.network.v20200801.PrivateDnsZoneConfigResponse[] | undefined>;
    /**
...
export interface PrivateDnsZoneGroupArgs {
     ...
     * A collection of private dns zone configurations of the private dns zone group.
     */
    readonly privateDnsZoneConfigs?: pulumi.Input<pulumi.Input<inputs.network.v20200801.PrivateDnsZoneConfigArgs>[]>;
    /**
