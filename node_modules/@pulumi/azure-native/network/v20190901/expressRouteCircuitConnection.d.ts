...
export declare class ExpressRouteCircuitConnection extends pulumi.CustomResource {
     ...
     */
    readonly expressRouteCircuitPeering: pulumi.Output<outputs.network.v20190901.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly peerExpressRouteCircuitPeering: pulumi.Output<outputs.network.v20190901.SubResourceResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitConnectionArgs {
     ...
     * Reference to Express Route Circuit Private Peering Resource of the circuit initiating connection.
     */
    readonly expressRouteCircuitPeering?: pulumi.Input<inputs.network.v20190901.SubResourceArgs>;
    /**
     * Resource ID.
     */
     ...
     * Reference to Express Route Circuit Private Peering Resource of the peered circuit.
     */
    readonly peerExpressRouteCircuitPeering?: pulumi.Input<inputs.network.v20190901.SubResourceArgs>;
    /**
