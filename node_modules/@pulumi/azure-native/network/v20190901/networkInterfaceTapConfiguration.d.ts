...
export declare class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly virtualNetworkTap: pulumi.Output<outputs.network.v20190901.VirtualNetworkTapResponse | undefined>;
    /**
...
export interface NetworkInterfaceTapConfigurationArgs {
     ...
     * The reference of the Virtual Network Tap resource.
     */
    readonly virtualNetworkTap?: pulumi.Input<inputs.network.v20190901.VirtualNetworkTapArgs>;
}
