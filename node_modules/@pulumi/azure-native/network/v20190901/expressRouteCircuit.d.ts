...
export declare class ExpressRouteCircuit extends pulumi.CustomResource {
     ...
     */
    readonly authorizations: pulumi.Output<outputs.network.v20190901.ExpressRouteCircuitAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    readonly expressRoutePort: pulumi.Output<outputs.network.v20190901.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly peerings: pulumi.Output<outputs.network.v20190901.ExpressRouteCircuitPeeringResponse[] | undefined>;
    /**
     ...
     */
    readonly serviceProviderProperties: pulumi.Output<outputs.network.v20190901.ExpressRouteCircuitServiceProviderPropertiesResponse | undefined>;
    /**
     ...
     * The SKU.
     */
    readonly sku: pulumi.Output<outputs.network.v20190901.ExpressRouteCircuitSkuResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitArgs {
     ...
     * The list of authorizations.
     */
    readonly authorizations?: pulumi.Input<pulumi.Input<inputs.network.v20190901.ExpressRouteCircuitAuthorizationArgs>[]>;
    /**
     * The bandwidth of the circuit when the circuit is provisioned on an ExpressRoutePort resource.
     */
     ...
     * The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
     */
    readonly expressRoutePort?: pulumi.Input<inputs.network.v20190901.SubResourceArgs>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The list of peerings.
     */
    readonly peerings?: pulumi.Input<pulumi.Input<inputs.network.v20190901.ExpressRouteCircuitPeeringArgs>[]>;
    /**
     ...
     * The ServiceProviderProperties.
     */
    readonly serviceProviderProperties?: pulumi.Input<inputs.network.v20190901.ExpressRouteCircuitServiceProviderPropertiesArgs>;
    /**
     * The ServiceProviderProvisioningState state of the resource.
     */
    readonly serviceProviderProvisioningState?: pulumi.Input<string | enums.network.v20190901.ServiceProviderProvisioningState>;
    /**
     * The SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.v20190901.ExpressRouteCircuitSkuArgs>;
    /**
     * Resource tags.
     */
