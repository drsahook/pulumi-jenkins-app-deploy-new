...
export declare class InboundNatRule extends pulumi.CustomResource {
     ...
     */
    readonly backendIPConfiguration: pulumi.Output<outputs.network.v20190901.NetworkInterfaceIPConfigurationResponse>;
    /**
     ...
     */
    readonly frontendIPConfiguration: pulumi.Output<outputs.network.v20190901.SubResourceResponse | undefined>;
    /**
...
export interface InboundNatRuleArgs {
     ...
     * A reference to frontend IP addresses.
     */
    readonly frontendIPConfiguration?: pulumi.Input<inputs.network.v20190901.SubResourceArgs>;
    /**
     * The port for the external endpoint. Port numbers for each rule must be unique within the Load Balancer. Acceptable values range from 1 to 65534.
     */
     ...
     * The reference to the transport protocol used by the load balancing rule.
     */
    readonly protocol?: pulumi.Input<string | enums.network.v20190901.TransportProtocol>;
    /**
