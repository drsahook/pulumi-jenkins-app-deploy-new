...
export declare class ExpressRouteCircuitPeering extends pulumi.CustomResource {
     ...
     */
    readonly connections: pulumi.Output<outputs.network.v20190901.ExpressRouteCircuitConnectionResponse[] | undefined>;
    /**
     ...
     */
    readonly expressRouteConnection: pulumi.Output<outputs.network.v20190901.ExpressRouteConnectionIdResponse | undefined>;
    /**
     ...
     */
    readonly ipv6PeeringConfig: pulumi.Output<outputs.network.v20190901.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly microsoftPeeringConfig: pulumi.Output<outputs.network.v20190901.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly peeredConnections: pulumi.Output<outputs.network.v20190901.PeerExpressRouteCircuitConnectionResponse[]>;
    /**
     * The peering type.
     */
     ...
     */
    readonly routeFilter: pulumi.Output<outputs.network.v20190901.SubResourceResponse | undefined>;
    /**
     * The secondary port.
     */
     ...
     */
    readonly stats: pulumi.Output<outputs.network.v20190901.ExpressRouteCircuitStatsResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * The list of circuit connections associated with Azure Private Peering for this circuit.
     */
    readonly connections?: pulumi.Input<pulumi.Input<inputs.network.v20190901.ExpressRouteCircuitConnectionArgs>[]>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The IPv6 peering configuration.
     */
    readonly ipv6PeeringConfig?: pulumi.Input<inputs.network.v20190901.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * The Microsoft peering configuration.
     */
    readonly microsoftPeeringConfig?: pulumi.Input<inputs.network.v20190901.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The peering type.
     */
    readonly peeringType?: pulumi.Input<string | enums.network.v20190901.ExpressRoutePeeringType>;
    /**
     * The primary port.
     */
     ...
     * The reference of the RouteFilter resource.
     */
    readonly routeFilter?: pulumi.Input<inputs.network.v20190901.SubResourceArgs>;
    /**
     * The secondary port.
     */
     ...
     * The peering state.
     */
    readonly state?: pulumi.Input<string | enums.network.v20190901.ExpressRoutePeeringState>;
    /**
     * The peering stats of express route circuit.
     */
    readonly stats?: pulumi.Input<inputs.network.v20190901.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */
