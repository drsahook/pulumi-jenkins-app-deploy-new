...
export declare class LocalNetworkGateway extends pulumi.CustomResource {
     ...
     */
    readonly localNetworkAddressSpace: pulumi.Output<outputs.network.v20190901.AddressSpaceResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network site address space.
     */
    readonly localNetworkAddressSpace?: pulumi.Input<inputs.network.v20190901.AddressSpaceArgs>;
    /**
