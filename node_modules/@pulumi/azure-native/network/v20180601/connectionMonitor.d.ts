...
export declare class ConnectionMonitor extends pulumi.CustomResource {
     ...
     */
    readonly destination: pulumi.Output<outputs.network.v20180601.ConnectionMonitorDestinationResponse>;
     ...
     */
    readonly source: pulumi.Output<outputs.network.v20180601.ConnectionMonitorSourceResponse>;
    /**
...
export interface ConnectionMonitorArgs {
     ...
     * Describes the destination of connection monitor.
     */
    readonly destination: pulumi.Input<inputs.network.v20180601.ConnectionMonitorDestinationArgs>;
    /**
     * Connection monitor location.
     */
     ...
     * Describes the source of connection monitor.
     */
    readonly source: pulumi.Input<inputs.network.v20180601.ConnectionMonitorSourceArgs>;
    /**
     * Connection monitor tags.
     */
