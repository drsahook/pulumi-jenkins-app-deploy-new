...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * The PeeringType. Possible values are: 'AzurePublicPeering', 'AzurePrivatePeering', and 'MicrosoftPeering'.
     */
    readonly peeringType?: pulumi.Input<string | enums.network.v20170601.ExpressRouteCircuitPeeringType>;
    /**
     * The primary port.
     */
     ...
     * The state of peering. Possible values are: 'Disabled' and 'Enabled'
     */
    readonly state?: pulumi.Input<string | enums.network.v20170601.ExpressRouteCircuitPeeringState>;
    /**
     * Gets peering stats.
     */
