...
export interface PublicIPAddressArgs {
     ...
     * The FQDN of the DNS record associated with the public IP address.
     */
    readonly dnsSettings?: pulumi.Input<inputs.network.v20171001.PublicIPAddressDnsSettingsArgs>;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * The public IP address version. Possible values are: 'IPv4' and 'IPv6'.
     */
    readonly publicIPAddressVersion?: pulumi.Input<string | enums.network.v20171001.IPVersion>;
    /**
     * The public IP allocation method. Possible values are: 'Static' and 'Dynamic'.
     */
    readonly publicIPAllocationMethod?: pulumi.Input<string | enums.network.v20171001.IPAllocationMethod>;
    /**
     ...
     * The public IP address SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.v20171001.PublicIPAddressSkuArgs>;
    /**
     * Resource tags.
     */
