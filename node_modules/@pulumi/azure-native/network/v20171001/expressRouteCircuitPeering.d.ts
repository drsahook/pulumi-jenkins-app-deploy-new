...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * The IPv6 peering configuration.
     */
    readonly ipv6PeeringConfig?: pulumi.Input<inputs.network.v20171001.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets whether the provider or the customer last modified the peering.
     */
     ...
     * The Microsoft peering configuration.
     */
    readonly microsoftPeeringConfig?: pulumi.Input<inputs.network.v20171001.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The PeeringType. Possible values are: 'AzurePublicPeering', 'AzurePrivatePeering', and 'MicrosoftPeering'.
     */
    readonly peeringType?: pulumi.Input<string | enums.network.v20171001.ExpressRouteCircuitPeeringType>;
    /**
     * The primary port.
     */
     ...
     * The reference of the RouteFilter resource.
     */
    readonly routeFilter?: pulumi.Input<inputs.network.v20171001.RouteFilterArgs>;
    /**
     * The secondary port.
     */
     ...
     * The state of peering. Possible values are: 'Disabled' and 'Enabled'
     */
    readonly state?: pulumi.Input<string | enums.network.v20171001.ExpressRouteCircuitPeeringState>;
    /**
     * Gets peering stats.
     */
    readonly stats?: pulumi.Input<inputs.network.v20171001.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */
