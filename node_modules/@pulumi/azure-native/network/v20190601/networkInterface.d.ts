...
export interface NetworkInterfaceArgs {
     ...
     * The DNS settings in network interface.
     */
    readonly dnsSettings?: pulumi.Input<inputs.network.v20190601.NetworkInterfaceDnsSettingsArgs>;
    /**
     * If the network interface is accelerated networking enabled.
     */
     ...
     * A list of IPConfigurations of the network interface.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20190601.NetworkInterfaceIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * A list of TapConfigurations of the network interface.
     */
    readonly tapConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20190601.NetworkInterfaceTapConfigurationArgs>[]>;
}
