...
export declare class P2sVpnGateway extends pulumi.CustomResource {
     ...
     */
    readonly p2SVpnServerConfiguration: pulumi.Output<outputs.network.v20190601.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly vpnClientAddressPool: pulumi.Output<outputs.network.v20190601.AddressSpaceResponse | undefined>;
    /**
     * All P2S VPN clients' connection health status.
     */
    readonly vpnClientConnectionHealth: pulumi.Output<outputs.network.v20190601.VpnClientConnectionHealthResponse>;
    /**
...
export interface P2sVpnGatewayArgs {
     ...
     * The P2SVpnServerConfiguration to which the p2sVpnGateway is attached to.
     */
    readonly p2SVpnServerConfiguration?: pulumi.Input<inputs.network.v20190601.SubResourceArgs>;
    /**
     ...
     * The reference of the address space resource which represents Address space for P2S VpnClient.
     */
    readonly vpnClientAddressPool?: pulumi.Input<inputs.network.v20190601.AddressSpaceArgs>;
    /**
     * The scale unit for this p2s vpn gateway.
     */
