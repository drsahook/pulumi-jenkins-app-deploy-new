...
export declare class BastionHost extends pulumi.CustomResource {
     ...
     */
    readonly ipConfigurations: pulumi.Output<outputs.network.v20190601.BastionHostIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface BastionHostArgs {
     ...
     * IP configuration of the Bastion Host resource.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20190601.BastionHostIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
