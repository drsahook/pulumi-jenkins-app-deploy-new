...
export interface AgentPoolArgs {
     ...
     * OsType to be used to specify os type. Choose from Linux and Windows. Default to Linux.
     */
    readonly osType?: pulumi.Input<string | enums.containerservice.v20200201.OSType>;
    /**
     ...
     * ScaleSetEvictionPolicy to be used to specify eviction policy for Spot or low priority virtual machine scale set. Default to Delete.
     */
    readonly scaleSetEvictionPolicy?: pulumi.Input<string | enums.containerservice.v20200201.ScaleSetEvictionPolicy>;
    /**
     * ScaleSetPriority to be used to specify virtual machine scale set priority. Default to regular.
     */
    readonly scaleSetPriority?: pulumi.Input<string | enums.containerservice.v20200201.ScaleSetPriority>;
    /**
     * SpotMaxPrice to be used to specify the maximum price you are willing to pay in US Dollars. Possible values are any decimal value greater than zero or -1 which indicates default price to be up-to on-demand.
     */
     ...
     * AgentPoolType represents types of an agent pool
     */
    readonly type?: pulumi.Input<string | enums.containerservice.v20200201.AgentPoolType>;
    /**
     * Size of agent VMs.
     */
    readonly vmSize?: pulumi.Input<string | enums.containerservice.v20200201.ContainerServiceVMSizeTypes>;
    /**
     * VNet SubnetID specifies the VNet's subnet identifier.
     */
