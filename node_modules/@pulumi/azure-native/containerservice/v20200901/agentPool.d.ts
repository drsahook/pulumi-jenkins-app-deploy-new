...
export declare class AgentPool extends pulumi.CustomResource {
     ...
     */
    readonly upgradeSettings: pulumi.Output<outputs.containerservice.v20200901.AgentPoolUpgradeSettingsResponse | undefined>;
    /**
     * Size of agent VMs.
     */
...
export interface AgentPoolArgs {
     ...
     * AgentPoolMode represents mode of an agent pool
     */
    readonly mode?: pulumi.Input<string | enums.containerservice.v20200901.AgentPoolMode>;
    /**
     * Agent pool node labels to be persisted across all nodes in agent pool.
     */
     ...
     * OS disk type to be used for machines in a given agent pool. Allowed values are 'Ephemeral' and 'Managed'. Defaults to 'Managed'. May not be changed after creation.
     */
    readonly osDiskType?: pulumi.Input<string | enums.containerservice.v20200901.OSDiskType>;
    /**
     * OsType to be used to specify os type. Choose from Linux and Windows. Default to Linux.
     */
    readonly osType?: pulumi.Input<string | enums.containerservice.v20200901.OSType>;
    /**
     * The ID for Proximity Placement Group.
     */
     ...
     * ScaleSetEvictionPolicy to be used to specify eviction policy for Spot virtual machine scale set. Default to Delete.
     */
    readonly scaleSetEvictionPolicy?: pulumi.Input<string | enums.containerservice.v20200901.ScaleSetEvictionPolicy>;
    /**
     * ScaleSetPriority to be used to specify virtual machine scale set priority. Default to regular.
     */
    readonly scaleSetPriority?: pulumi.Input<string | enums.containerservice.v20200901.ScaleSetPriority>;
    /**
     * SpotMaxPrice to be used to specify the maximum price you are willing to pay in US Dollars. Possible values are any decimal value greater than zero or -1 which indicates default price to be up-to on-demand.
     */
     ...
     * AgentPoolType represents types of an agent pool
     */
    readonly type?: pulumi.Input<string | enums.containerservice.v20200901.AgentPoolType>;
    /**
     * Settings for upgrading the agentpool
     */
    readonly upgradeSettings?: pulumi.Input<inputs.containerservice.v20200901.AgentPoolUpgradeSettingsArgs>;
    /**
     * Size of agent VMs.
     */
    readonly vmSize?: pulumi.Input<string | enums.containerservice.v20200901.ContainerServiceVMSizeTypes>;
    /**
     * VNet SubnetID specifies the VNet's subnet identifier.
     */
