...
export declare class AgentPool extends pulumi.CustomResource {
     ...
     */
    readonly kubeletConfig: pulumi.Output<outputs.containerservice.v20201201.KubeletConfigResponse | undefined>;
    /**
     ...
     */
    readonly linuxOSConfig: pulumi.Output<outputs.containerservice.v20201201.LinuxOSConfigResponse | undefined>;
    /**
     ...
     */
    readonly upgradeSettings: pulumi.Output<outputs.containerservice.v20201201.AgentPoolUpgradeSettingsResponse | undefined>;
    /**
     * Size of agent VMs.
     */
...
export interface AgentPoolArgs {
     ...
     * KubeletConfig specifies the configuration of kubelet on agent nodes.
     */
    readonly kubeletConfig?: pulumi.Input<inputs.containerservice.v20201201.KubeletConfigArgs>;
    /**
     * KubeletDiskType determines the placement of emptyDir volumes, container runtime data root, and Kubelet ephemeral storage. Currently allows one value, OS, resulting in Kubelet using the OS disk for data.
     */
    readonly kubeletDiskType?: pulumi.Input<string | enums.containerservice.v20201201.KubeletDiskType>;
    /**
     * LinuxOSConfig specifies the OS configuration of linux agent nodes.
     */
    readonly linuxOSConfig?: pulumi.Input<inputs.containerservice.v20201201.LinuxOSConfigArgs>;
    /**
     * Maximum number of nodes for auto-scaling
     */
     ...
     * AgentPoolMode represents mode of an agent pool
     */
    readonly mode?: pulumi.Input<string | enums.containerservice.v20201201.AgentPoolMode>;
    /**
     * Agent pool node labels to be persisted across all nodes in agent pool.
     */
     ...
     * OS disk type to be used for machines in a given agent pool. Allowed values are 'Ephemeral' and 'Managed'. If unspecified, defaults to 'Ephemeral' when the VM supports ephemeral OS and has a cache disk larger than the requested OSDiskSizeGB. Otherwise, defaults to 'Managed'. May not be changed after creation.
     */
    readonly osDiskType?: pulumi.Input<string | enums.containerservice.v20201201.OSDiskType>;
    /**
     * OsType to be used to specify os type. Choose from Linux and Windows. Default to Linux.
     */
    readonly osType?: pulumi.Input<string | enums.containerservice.v20201201.OSType>;
    /**
     * Pod SubnetID specifies the VNet's subnet identifier for pods.
     */
     ...
     * ScaleSetEvictionPolicy to be used to specify eviction policy for Spot virtual machine scale set. Default to Delete.
     */
    readonly scaleSetEvictionPolicy?: pulumi.Input<string | enums.containerservice.v20201201.ScaleSetEvictionPolicy>;
    /**
     * ScaleSetPriority to be used to specify virtual machine scale set priority. Default to regular.
     */
    readonly scaleSetPriority?: pulumi.Input<string | enums.containerservice.v20201201.ScaleSetPriority>;
    /**
     * SpotMaxPrice to be used to specify the maximum price you are willing to pay in US Dollars. Possible values are any decimal value greater than zero or -1 which indicates default price to be up-to on-demand.
     */
     ...
     * AgentPoolType represents types of an agent pool
     */
    readonly type?: pulumi.Input<string | enums.containerservice.v20201201.AgentPoolType>;
    /**
     * Settings for upgrading the agentpool
     */
    readonly upgradeSettings?: pulumi.Input<inputs.containerservice.v20201201.AgentPoolUpgradeSettingsArgs>;
    /**
     * Size of agent VMs.
     */
    readonly vmSize?: pulumi.Input<string | enums.containerservice.v20201201.ContainerServiceVMSizeTypes>;
    /**
     * VNet SubnetID specifies the VNet's subnet identifier for nodes and maybe pods
     */
