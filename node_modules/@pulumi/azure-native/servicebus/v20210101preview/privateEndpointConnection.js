...
class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicebus/v20210101preview:PrivateEndpointConnection" }, { type: "azure-native:servicebus:PrivateEndpointConnection" }, { type: "azure-nextgen:servicebus:PrivateEndpointConnection" }, { type: "azure-native:servicebus/v20180101preview:PrivateEndpointConnection" }, { type: "azure-nextgen:servicebus/v20180101preview:PrivateEndpointConnection" }] };
...
/** @internal */
PrivateEndpointConnection.__pulumiType = 'azure-native:servicebus/v20210101preview:PrivateEndpointConnection';
