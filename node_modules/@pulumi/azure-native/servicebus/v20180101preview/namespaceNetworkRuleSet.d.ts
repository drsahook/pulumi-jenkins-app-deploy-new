...
export declare class NamespaceNetworkRuleSet extends pulumi.CustomResource {
     ...
     * List of IpRules
     */
    readonly ipRules: pulumi.Output<outputs.servicebus.v20180101preview.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     * Resource name
     */
     ...
     */
    readonly virtualNetworkRules: pulumi.Output<outputs.servicebus.v20180101preview.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;
    /**
...
export interface NamespaceNetworkRuleSetArgs {
     ...
     * Default Action for Network Rule Set
     */
    readonly defaultAction?: pulumi.Input<string | enums.servicebus.v20180101preview.DefaultAction>;
    /**
     * List of IpRules
     */
    readonly ipRules?: pulumi.Input<pulumi.Input<inputs.servicebus.v20180101preview.NWRuleSetIpRulesArgs>[]>;
    /**
     * The namespace name
     */
     ...
     * List VirtualNetwork Rules
     */
    readonly virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.servicebus.v20180101preview.NWRuleSetVirtualNetworkRulesArgs>[]>;
}
