...
export interface HostPoolArgs {
     ...
     * The type of the load balancer.
     */
    readonly loadBalancerType: pulumi.Input<string | enums.desktopvirtualization.v20201110preview.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * PersonalDesktopAssignment type for HostPool.
     */
    readonly personalDesktopAssignmentType?: pulumi.Input<string | enums.desktopvirtualization.v20201110preview.PersonalDesktopAssignmentType>;
    /**
     * The type of preferred application group type, default to Desktop Application Group
     */
    readonly preferredAppGroupType: pulumi.Input<string | enums.desktopvirtualization.v20201110preview.PreferredAppGroupType>;
    /**
     * The registration info of HostPool.
     */
    readonly registrationInfo?: pulumi.Input<inputs.desktopvirtualization.v20201110preview.RegistrationInfoArgs>;
    /**
     ...
     * The type of single sign on Secret Type.
     */
    readonly ssoSecretType?: pulumi.Input<string | enums.desktopvirtualization.v20201110preview.SSOSecretType>;
    /**
     * URL to customer ADFS server for signing WVD SSO certificates.
     */
