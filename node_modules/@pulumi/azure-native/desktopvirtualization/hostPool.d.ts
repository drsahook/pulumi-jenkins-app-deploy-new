...
export declare class HostPool extends pulumi.CustomResource {
     ...
     */
    readonly migrationRequest: pulumi.Output<outputs.desktopvirtualization.MigrationRequestPropertiesResponse | undefined>;
    /**
...
export interface HostPoolArgs {
     ...
     * The type of the load balancer.
     */
    readonly loadBalancerType: pulumi.Input<string | enums.desktopvirtualization.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The type of preferred application group type, default to Desktop Application Group
     */
    readonly preferredAppGroupType: pulumi.Input<string | enums.desktopvirtualization.PreferredAppGroupType>;
    /**
     * The registration info of HostPool.
     */
     ...
     * The type of single sign on Secret Type.
     */
    readonly ssoSecretType?: pulumi.Input<string | enums.desktopvirtualization.SSOSecretType>;
    /**
     * URL to customer ADFS server for signing WVD SSO certificates.
     */
