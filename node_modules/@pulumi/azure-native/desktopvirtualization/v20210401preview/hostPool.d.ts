...
export declare class HostPool extends pulumi.CustomResource {
    ...
    readonly identity: pulumi.Output<outputs.desktopvirtualization.v20210401preview.ResourceModelWithAllowedPropertySetResponseIdentity | undefined>;
    /**
     ...
     */
    readonly migrationRequest: pulumi.Output<outputs.desktopvirtualization.v20210401preview.MigrationRequestPropertiesResponse | undefined>;
    /**
    ...
    readonly plan: pulumi.Output<outputs.desktopvirtualization.v20210401preview.ResourceModelWithAllowedPropertySetResponsePlan | undefined>;
    /**
     ...
     * The registration info of HostPool.
     */
    readonly registrationInfo: pulumi.Output<outputs.desktopvirtualization.v20210401preview.RegistrationInfoResponse | undefined>;
    /**
     * The ring number of HostPool.
     */
    readonly ring: pulumi.Output<number | undefined>;
    readonly sku: pulumi.Output<outputs.desktopvirtualization.v20210401preview.ResourceModelWithAllowedPropertySetResponseSku | undefined>;
    /**
...
export interface HostPoolArgs {
     ...
     * The type of the load balancer.
     */
    readonly loadBalancerType: pulumi.Input<string | enums.desktopvirtualization.v20210401preview.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * PersonalDesktopAssignment type for HostPool.
     */
    readonly personalDesktopAssignmentType?: pulumi.Input<string | enums.desktopvirtualization.v20210401preview.PersonalDesktopAssignmentType>;
    readonly plan?: pulumi.Input<inputs.desktopvirtualization.v20210401preview.ResourceModelWithAllowedPropertySetPlanArgs>;
    /**
     * The type of preferred application group type, default to Desktop Application Group
     */
    readonly preferredAppGroupType: pulumi.Input<string | enums.desktopvirtualization.v20210401preview.PreferredAppGroupType>;
    /**
     * Enabled allows this resource to be accessed from both public and private networks, Disabled allows this resource to only be accessed via private endpoints
     */
     ...
     * The registration info of HostPool.
     */
    readonly registrationInfo?: pulumi.Input<inputs.desktopvirtualization.v20210401preview.RegistrationInfoArgs>;
    /**
     ...
     * The type of single sign on Secret Type.
     */
    readonly ssoSecretType?: pulumi.Input<string | enums.desktopvirtualization.v20210401preview.SSOSecretType>;
    /**
     * URL to customer ADFS server for signing WVD SSO certificates.
     */
