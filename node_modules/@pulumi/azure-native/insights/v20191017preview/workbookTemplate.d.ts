...
export declare class WorkbookTemplate extends pulumi.CustomResource {
     ...
     */
    readonly galleries: pulumi.Output<outputs.insights.v20191017preview.WorkbookTemplateGalleryResponse[]>;
    /**
...
export interface WorkbookTemplateArgs {
     ...
     * Key value pair of localized gallery. Each key is the locale code of languages supported by the Azure portal.
     */
    readonly localized?: pulumi.Input<{
        [key: string]: pulumi.Input<pulumi.Input<inputs.insights.v20191017preview.WorkbookTemplateLocalizedGalleryArgs>[]>;
    }>;
    /**
     * Resource location
     */
