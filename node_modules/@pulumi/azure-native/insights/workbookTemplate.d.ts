...
export declare class WorkbookTemplate extends pulumi.CustomResource {
     ...
     */
    readonly galleries: pulumi.Output<outputs.insights.WorkbookTemplateGalleryResponse[]>;
    /**
...
export interface WorkbookTemplateArgs {
    ...
    readonly localized?: pulumi.Input<{
        [key: string]: pulumi.Input<pulumi.Input<inputs.insights.WorkbookTemplateLocalizedGalleryArgs>[]>;
    }>;
    /**
     * Resource location
     */
