...
export declare class ProactiveDetectionConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly ruleDefinitions: pulumi.Output<outputs.insights.ApplicationInsightsComponentProactiveDetectionConfigurationResponseRuleDefinitions | undefined>;
    /**
...
export interface ProactiveDetectionConfigurationArgs {
     ...
     * Static definitions of the ProactiveDetection configuration rule (same values for all components).
     */
    readonly ruleDefinitions?: pulumi.Input<inputs.insights.ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitionsArgs>;
    /**
     * A flag that indicated whether notifications on this rule should be sent to subscription owners
     */
