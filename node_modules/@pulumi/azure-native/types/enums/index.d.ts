...
export { aad, aadiam, alertsmanagement, analysisservices, apimanagement, appconfiguration, appplatform, attestation, authorization, automanage, automation, avs, azureactivedirectory, azurestack, azurestackhci, batch, batchai, blockchain, blueprint, botservice, cache, cdn, certificateregistration, changeanalysis, cognitiveservices, compute, confidentialledger, confluent, consumption, containerinstance, containerregistry, containerservice, costmanagement, customerinsights, customproviders, databox, databoxedge, databricks, datacatalog, datadog, datafactory, datalakeanalytics, datalakestore, datamigration, dataprotection, datashare, dbformariadb, dbformysql, dbforpostgresql, delegatednetwork, deploymentmanager, desktopvirtualization, devices, deviceupdate, devops, devspaces, devtestlab, digitaltwins, documentdb, domainregistration, edgeorder, elastic, enterpriseknowledgegraph, eventgrid, eventhub, extendedlocation, guestconfiguration, hanaonazure, hdinsight, healthbot, healthcareapis, hybridcompute, hybriddata, hybridnetwork, importexport, insights, iotcentral, iotsecurity, iotspaces, keyvault, kubernetes, kubernetesconfiguration, kusto, labservices, logic, logz, m365securityandcompliance, machinelearning, machinelearningcompute, machinelearningservices, maintenance, managednetwork, managedservices, maps, marketplace, media, migrate, mixedreality, netapp, network, notificationhubs, operationalinsights, peering, policyinsights, portal, powerbi, powerbidedicated, powerplatform, providerhub, purview, quantum, recoveryservices, relay, resources, saas, scheduler, search, security, securityandcompliance, securityinsights, serialconsole, servicebus, servicefabric, servicefabricmesh, signalrservice, solutions, sql, sqlvirtualmachine, storage, storagecache, storagepool, storagesync, storsimple, streamanalytics, subscription, synapse, testbase, timeseriesinsights, videoanalyzer, virtualmachineimages, visualstudio, vmwarecloudsimple, web, webpubsub, windowsesu, };
