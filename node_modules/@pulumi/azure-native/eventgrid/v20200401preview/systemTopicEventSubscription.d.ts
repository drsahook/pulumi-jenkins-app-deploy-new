...
export declare class SystemTopicEventSubscription extends pulumi.CustomResource {
     ...
     */
    readonly deadLetterDestination: pulumi.Output<outputs.eventgrid.v20200401preview.StorageBlobDeadLetterDestinationResponse | undefined>;
    /**
     * The dead letter destination of the event subscription. Any event that cannot be delivered to its' destination is sent to the dead letter destination.
     * Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being used during delivery / dead-lettering.
     */
    readonly deadLetterWithResourceIdentity: pulumi.Output<outputs.eventgrid.v20200401preview.DeadLetterWithResourceIdentityResponse | undefined>;
    /**
     * Information about the destination where events have to be delivered for the event subscription.
     * Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being used during delivery / dead-lettering.
     */
    readonly deliveryWithResourceIdentity: pulumi.Output<outputs.eventgrid.v20200401preview.DeliveryWithResourceIdentityResponse | undefined>;
    /**
     * Information about the destination where events have to be delivered for the event subscription.
     * Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
     */
     ...
     */
    readonly filter: pulumi.Output<outputs.eventgrid.v20200401preview.EventSubscriptionFilterResponse | undefined>;
    /**
     ...
     */
    readonly retryPolicy: pulumi.Output<outputs.eventgrid.v20200401preview.RetryPolicyResponse | undefined>;
    /**
