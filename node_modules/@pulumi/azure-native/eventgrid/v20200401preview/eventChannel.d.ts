...
export declare class EventChannel extends pulumi.CustomResource {
     ...
     */
    readonly destination: pulumi.Output<outputs.eventgrid.v20200401preview.EventChannelDestinationResponse | undefined>;
    /**
     ...
     */
    readonly filter: pulumi.Output<outputs.eventgrid.v20200401preview.EventChannelFilterResponse | undefined>;
    /**
     ...
     */
    readonly source: pulumi.Output<outputs.eventgrid.v20200401preview.EventChannelSourceResponse | undefined>;
    /**
...
export interface EventChannelArgs {
     ...
     * Represents the destination of an event channel.
     */
    readonly destination?: pulumi.Input<inputs.eventgrid.v20200401preview.EventChannelDestinationArgs>;
    /**
     ...
     * Information about the filter for the event channel.
     */
    readonly filter?: pulumi.Input<inputs.eventgrid.v20200401preview.EventChannelFilterArgs>;
    /**
     ...
     * Source of the event channel. This represents a unique resource in the partner's resource model.
     */
    readonly source?: pulumi.Input<inputs.eventgrid.v20200401preview.EventChannelSourceArgs>;
}
