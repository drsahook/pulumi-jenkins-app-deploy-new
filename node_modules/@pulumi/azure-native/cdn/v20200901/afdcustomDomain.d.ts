...
export declare class AFDCustomDomain extends pulumi.CustomResource {
     ...
     */
    readonly azureDnsZone: pulumi.Output<outputs.cdn.v20200901.ResourceReferenceResponse | undefined>;
     ...
     */
    readonly tlsSettings: pulumi.Output<outputs.cdn.v20200901.AFDDomainHttpsParametersResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    readonly validationProperties: pulumi.Output<outputs.cdn.v20200901.DomainValidationPropertiesResponse>;
    /**
...
export interface AFDCustomDomainArgs {
     ...
     * Resource reference to the Azure DNS zone
     */
    readonly azureDnsZone?: pulumi.Input<inputs.cdn.v20200901.ResourceReferenceArgs>;
    /**
     ...
     * The configuration specifying how to enable HTTPS for the domain - using AzureFrontDoor managed certificate or user's own certificate. If not specified, enabling ssl uses AzureFrontDoor managed certificate by default.
     */
    readonly tlsSettings?: pulumi.Input<inputs.cdn.v20200901.AFDDomainHttpsParametersArgs>;
}
