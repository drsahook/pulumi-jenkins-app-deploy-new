...
export declare class OriginGroup extends pulumi.CustomResource {
     ...
     */
    readonly healthProbeSettings: pulumi.Output<outputs.cdn.v20200901.HealthProbeParametersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    readonly origins: pulumi.Output<outputs.cdn.v20200901.ResourceReferenceResponse[]>;
    /**
     ...
     */
    readonly responseBasedOriginErrorDetectionSettings: pulumi.Output<outputs.cdn.v20200901.ResponseBasedOriginErrorDetectionParametersResponse | undefined>;
    /**
...
export interface OriginGroupArgs {
     ...
     * The source of the content being delivered via CDN within given origin group.
     */
    readonly origins: pulumi.Input<pulumi.Input<inputs.cdn.v20200901.ResourceReferenceArgs>[]>;
    /**
     ...
     * The JSON object that contains the properties to determine origin health using real requests/responses. This property is currently not supported.
     */
    readonly responseBasedOriginErrorDetectionSettings?: pulumi.Input<inputs.cdn.v20200901.ResponseBasedOriginErrorDetectionParametersArgs>;
    /**
     * Time in minutes to shift the traffic to the endpoint gradually when an unhealthy endpoint comes healthy or a new endpoint is added. Default is 10 mins. This property is currently not supported.
     */
