...
export declare class ReplicationProtectedItem extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20210301.ReplicationProtectedItemPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationProtectedItemArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.v20210301.EnableProtectionInputPropertiesArgs>;
    /**
