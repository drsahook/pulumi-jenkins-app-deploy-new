...
export declare class ReplicationStorageClassificationMapping extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20180710.StorageClassificationMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationStorageClassificationMappingArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.v20180710.StorageMappingInputPropertiesArgs>;
    /**
