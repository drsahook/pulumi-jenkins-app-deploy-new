...
export declare class ReplicationStorageClassificationMapping extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20210210.StorageClassificationMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationStorageClassificationMappingArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.v20210210.StorageMappingInputPropertiesArgs>;
    /**
