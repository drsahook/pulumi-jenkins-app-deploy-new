...
export declare class ReplicationRecoveryPlan extends pulumi.CustomResource {
     ...
     * The custom details.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20210210.RecoveryPlanPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryPlanArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.recoveryservices.v20210210.CreateRecoveryPlanInputPropertiesArgs>;
    /**
     * Recovery plan name.
     */
