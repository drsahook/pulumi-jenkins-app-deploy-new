...
export declare class ReplicationFabric extends pulumi.CustomResource {
     ...
     * Fabric related data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20210210.FabricPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationFabricArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.recoveryservices.v20210210.FabricCreationInputPropertiesArgs>;
    /**
