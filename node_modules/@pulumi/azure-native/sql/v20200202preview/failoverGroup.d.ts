...
export declare class FailoverGroup extends pulumi.CustomResource {
     ...
     */
    readonly partnerServers: pulumi.Output<outputs.sql.v20200202preview.PartnerInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint: pulumi.Output<outputs.sql.v20200202preview.FailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: pulumi.Output<outputs.sql.v20200202preview.FailoverGroupReadWriteEndpointResponse>;
    /**
...
export interface FailoverGroupArgs {
     ...
     * List of partner server information for the failover group.
     */
    readonly partnerServers: pulumi.Input<pulumi.Input<inputs.sql.v20200202preview.PartnerInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: pulumi.Input<inputs.sql.v20200202preview.FailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: pulumi.Input<inputs.sql.v20200202preview.FailoverGroupReadWriteEndpointArgs>;
    /**
