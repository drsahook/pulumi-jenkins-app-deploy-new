...
export declare class ManagedInstance extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.v20200202preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.sql.v20200202preview.ManagedInstancePecPropertyResponse[]>;
...
export interface ManagedInstanceArgs {
     ...
     * The license type. Possible values are 'LicenseIncluded' (regular price inclusive of a new SQL license) and 'BasePrice' (discounted AHB price for bringing your own SQL licenses).
     */
    readonly licenseType?: pulumi.Input<string | enums.sql.v20200202preview.ManagedInstanceLicenseType>;
    /**
     * Resource location.
     */
     ...
     */
    readonly managedInstanceCreateMode?: pulumi.Input<string | enums.sql.v20200202preview.ManagedServerCreateMode>;
    /**
     ...
     * Connection type used for connecting to the instance.
     */
    readonly proxyOverride?: pulumi.Input<string | enums.sql.v20200202preview.ManagedInstanceProxyOverride>;
    /**
     * Whether or not the public data endpoint is enabled.
     */
