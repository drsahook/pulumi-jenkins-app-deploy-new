...
export declare class DatabaseSecurityAlertPolicy extends pulumi.CustomResource {
     ...
     */
    readonly systemData: pulumi.Output<outputs.sql.v20200202preview.SystemDataResponse>;
    /**
     * Resource type.
     */
...
export interface DatabaseSecurityAlertPolicyArgs {
     ...
     * Specifies the state of the policy, whether it is enabled or disabled or a policy has not been applied yet on the specific database.
     */
    readonly state: pulumi.Input<enums.sql.v20200202preview.SecurityAlertsPolicyState>;
    /**
     * Specifies the identifier key of the Threat Detection audit storage account.
     */
