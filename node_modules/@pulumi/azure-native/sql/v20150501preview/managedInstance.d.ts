...
export declare class ManagedInstance extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.v20150501preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.sql.v20150501preview.SkuResponse | undefined>;
    /**
...
export interface ManagedInstanceArgs {
     ...
     * Managed instance SKU. Allowed values for sku.name: GP_Gen4, GP_Gen5, BC_Gen4, BC_Gen5
     */
    readonly sku?: pulumi.Input<inputs.sql.v20150501preview.SkuArgs>;
    /**
