...
export declare class SyncGroup extends pulumi.CustomResource {
     ...
     */
    readonly schema: pulumi.Output<outputs.sql.v20150501preview.SyncGroupSchemaResponse | undefined>;
    /**
...
export interface SyncGroupArgs {
     ...
     * Conflict resolution policy of the sync group.
     */
    readonly conflictResolutionPolicy?: pulumi.Input<string | enums.sql.v20150501preview.SyncConflictResolutionPolicy>;
    /**
