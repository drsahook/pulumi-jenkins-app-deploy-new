...
export declare class Database extends pulumi.CustomResource {
     ...
     */
    readonly currentSku: pulumi.Output<outputs.sql.v20201101preview.SkuResponse>;
    /**
...
export interface DatabaseArgs {
     ...
     * Collation of the metadata catalog.
     */
    readonly catalogCollation?: pulumi.Input<string | enums.sql.v20201101preview.CatalogCollationType>;
    /**
     * The collation of the database.
     */
     ...
     */
    readonly createMode?: pulumi.Input<string | enums.sql.v20201101preview.CreateMode>;
    /**
     ...
     * The license type to apply for this database. `LicenseIncluded` if you need a license, or `BasePrice` if you have a license and are eligible for the Azure Hybrid Benefit.
     */
    readonly licenseType?: pulumi.Input<string | enums.sql.v20201101preview.DatabaseLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The state of read-only routing. If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica in the same region.
     */
    readonly readScale?: pulumi.Input<string | enums.sql.v20201101preview.DatabaseReadScale>;
    /**
     ...
     * The storage account type to be used to store backups for this database.
     */
    readonly requestedBackupStorageRedundancy?: pulumi.Input<string | enums.sql.v20201101preview.RequestedBackupStorageRedundancy>;
    /**
     ...
     */
    readonly sampleName?: pulumi.Input<string | enums.sql.v20201101preview.SampleName>;
    /**
     * The secondary type of the database if it is a secondary.  Valid values are Geo and Named.
     */
    readonly secondaryType?: pulumi.Input<string | enums.sql.v20201101preview.SecondaryType>;
    /**
