...
export declare class SyncGroup extends pulumi.CustomResource {
     ...
     */
    readonly schema: pulumi.Output<outputs.sql.v20201101preview.SyncGroupSchemaResponse | undefined>;
    /**
...
export interface SyncGroupArgs {
     ...
     * Conflict resolution policy of the sync group.
     */
    readonly conflictResolutionPolicy?: pulumi.Input<string | enums.sql.v20201101preview.SyncConflictResolutionPolicy>;
    /**
     ...
     * Sync schema of the sync group.
     */
    readonly schema?: pulumi.Input<inputs.sql.v20201101preview.SyncGroupSchemaArgs>;
    /**
