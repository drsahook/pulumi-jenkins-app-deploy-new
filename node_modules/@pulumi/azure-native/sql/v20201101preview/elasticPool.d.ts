...
export interface ElasticPoolArgs {
     ...
     * The license type to apply for this elastic pool.
     */
    readonly licenseType?: pulumi.Input<string | enums.sql.v20201101preview.ElasticPoolLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The per database settings for the elastic pool.
     */
    readonly perDatabaseSettings?: pulumi.Input<inputs.sql.v20201101preview.ElasticPoolPerDatabaseSettingsArgs>;
    /**
