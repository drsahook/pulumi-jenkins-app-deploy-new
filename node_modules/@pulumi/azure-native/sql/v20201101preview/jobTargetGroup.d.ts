...
export declare class JobTargetGroup extends pulumi.CustomResource {
     ...
     */
    readonly members: pulumi.Output<outputs.sql.v20201101preview.JobTargetResponse[]>;
    /**
     * Resource name.
     */
...
export interface JobTargetGroupArgs {
     ...
     * Members of the target group.
     */
    readonly members: pulumi.Input<pulumi.Input<inputs.sql.v20201101preview.JobTargetArgs>[]>;
    /**
