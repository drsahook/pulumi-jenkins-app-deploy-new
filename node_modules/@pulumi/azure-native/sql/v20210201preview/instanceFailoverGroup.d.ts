...
export declare class InstanceFailoverGroup extends pulumi.CustomResource {
     ...
     */
    readonly managedInstancePairs: pulumi.Output<outputs.sql.v20210201preview.ManagedInstancePairInfoResponse[]>;
    /**
     * Resource name.
     */
     ...
     */
    readonly partnerRegions: pulumi.Output<outputs.sql.v20210201preview.PartnerRegionInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint: pulumi.Output<outputs.sql.v20210201preview.InstanceFailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: pulumi.Output<outputs.sql.v20210201preview.InstanceFailoverGroupReadWriteEndpointResponse>;
    /**
...
export interface InstanceFailoverGroupArgs {
     ...
     * List of managed instance pairs in the failover group.
     */
    readonly managedInstancePairs: pulumi.Input<pulumi.Input<inputs.sql.v20210201preview.ManagedInstancePairInfoArgs>[]>;
    /**
     * Partner region information for the failover group.
     */
    readonly partnerRegions: pulumi.Input<pulumi.Input<inputs.sql.v20210201preview.PartnerRegionInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: pulumi.Input<inputs.sql.v20210201preview.InstanceFailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: pulumi.Input<inputs.sql.v20210201preview.InstanceFailoverGroupReadWriteEndpointArgs>;
    /**
