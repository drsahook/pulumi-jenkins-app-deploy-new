...
export declare class Server extends pulumi.CustomResource {
     ...
     */
    readonly administrators: pulumi.Output<outputs.sql.v20210201preview.ServerExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.sql.v20210201preview.ServerPrivateEndpointConnectionResponse[]>;
    /**
...
export interface ServerArgs {
     ...
     * The Azure Active Directory identity of the server.
     */
    readonly administrators?: pulumi.Input<inputs.sql.v20210201preview.ServerExternalAdministratorArgs>;
    /**
     * The Client id used for cross tenant CMK scenario
     */
     ...
     * Whether or not public endpoint access is allowed for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    readonly publicNetworkAccess?: pulumi.Input<string | enums.sql.v20210201preview.ServerNetworkAccessFlag>;
    /**
     ...
     * Whether or not to restrict outbound network access for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    readonly restrictOutboundNetworkAccess?: pulumi.Input<string | enums.sql.v20210201preview.ServerNetworkAccessFlag>;
    /**
