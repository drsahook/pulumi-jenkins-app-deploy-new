...
export declare class ManagedInstance extends pulumi.CustomResource {
     ...
     */
    readonly administrators: pulumi.Output<outputs.sql.v20210201preview.ManagedInstanceExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.v20210201preview.ResourceIdentityWithUserAssignedIdentitiesResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.sql.v20210201preview.ManagedInstancePecPropertyResponse[]>;
     ...
     */
    readonly sku: pulumi.Output<outputs.sql.v20210201preview.SkuResponse | undefined>;
    /**
...
export interface ManagedInstanceArgs {
     ...
     * The Azure Active Directory administrator of the server.
     */
    readonly administrators?: pulumi.Input<inputs.sql.v20210201preview.ManagedInstanceExternalAdministratorArgs>;
    /**
     * Collation of the managed instance.
     */
     ...
     * The Azure Active Directory identity of the managed instance.
     */
    readonly identity?: pulumi.Input<inputs.sql.v20210201preview.ResourceIdentityWithUserAssignedIdentitiesArgs>;
    /**
     * The Id of the instance pool this managed server belongs to.
     */
     ...
     * The license type. Possible values are 'LicenseIncluded' (regular price inclusive of a new SQL license) and 'BasePrice' (discounted AHB price for bringing your own SQL licenses).
     */
    readonly licenseType?: pulumi.Input<string | enums.sql.v20210201preview.ManagedInstanceLicenseType>;
    /**
     * Resource location.
     */
     ...
     */
    readonly managedInstanceCreateMode?: pulumi.Input<string | enums.sql.v20210201preview.ManagedServerCreateMode>;
    /**
     ...
     * Connection type used for connecting to the instance.
     */
    readonly proxyOverride?: pulumi.Input<string | enums.sql.v20210201preview.ManagedInstanceProxyOverride>;
    /**
     * Whether or not the public data endpoint is enabled.
     */
     ...
     * The storage account type used to store backups for this instance. The options are LRS (LocallyRedundantStorage), ZRS (ZoneRedundantStorage) and GRS (GeoRedundantStorage)
     */
    readonly storageAccountType?: pulumi.Input<string | enums.sql.v20210201preview.StorageAccountType>;
    /**
     * Storage size in GB. Minimum value: 32. Maximum value: 8192. Increments of 32 GB allowed only.
     */
