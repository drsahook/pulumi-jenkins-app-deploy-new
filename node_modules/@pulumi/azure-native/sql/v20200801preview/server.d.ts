...
export declare class Server extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.v20200801preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.sql.v20200801preview.ServerPrivateEndpointConnectionResponse[]>;
    /**
...
export interface ServerArgs {
     ...
     * Whether or not public endpoint access is allowed for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    readonly publicNetworkAccess?: pulumi.Input<string | enums.sql.v20200801preview.ServerPublicNetworkAccess>;
    /**
