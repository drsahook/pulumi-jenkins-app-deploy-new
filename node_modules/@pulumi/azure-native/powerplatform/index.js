...
exports.v20201030preview = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
// Export members:
__exportStar(require("./enterprisePolicy"), exports);
__exportStar(require("./getEnterprisePolicy"), exports);
...
// Export sub-modules:
const v20201030preview = require("./v20201030preview");
exports.v20201030preview = v20201030preview;
// Import resources to register:
const enterprisePolicy_1 = require("./enterprisePolicy");
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "azure-native:powerplatform:EnterprisePolicy":
                return new enterprisePolicy_1.EnterprisePolicy(name, undefined, { urn });
