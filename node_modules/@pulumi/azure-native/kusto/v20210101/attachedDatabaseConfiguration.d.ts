...
export declare class AttachedDatabaseConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly tableLevelSharingProperties: pulumi.Output<outputs.kusto.v20210101.TableLevelSharingPropertiesResponse | undefined>;
    /**
...
export interface AttachedDatabaseConfigurationArgs {
     ...
     * The default principals modification kind
     */
    readonly defaultPrincipalsModificationKind: pulumi.Input<string | enums.kusto.v20210101.DefaultPrincipalsModificationKind>;
    /**
     * Resource location.
     */
     ...
     * Table level sharing specifications
     */
    readonly tableLevelSharingProperties?: pulumi.Input<inputs.kusto.v20210101.TableLevelSharingPropertiesArgs>;
}
