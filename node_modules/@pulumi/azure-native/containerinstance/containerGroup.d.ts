...
export declare class ContainerGroup extends pulumi.CustomResource {
     ...
     */
    readonly instanceView: pulumi.Output<outputs.containerinstance.ContainerGroupResponseInstanceView>;
    /**
     ...
     */
    readonly networkProfile: pulumi.Output<outputs.containerinstance.ContainerGroupNetworkProfileResponse | undefined>;
    /**
