...
export declare class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.cache.v20201201.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.cache.v20201201.PrivateLinkServiceConnectionStateResponse>;
    /**
...
export interface PrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Input<inputs.cache.v20201201.PrivateLinkServiceConnectionStateArgs>;
    /**
