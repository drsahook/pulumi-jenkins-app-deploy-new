...
export declare class Database extends pulumi.CustomResource {
     ...
     */
    readonly modules: pulumi.Output<outputs.cache.ModuleResponse[] | undefined>;
    /**
     ...
     */
    readonly persistence: pulumi.Output<outputs.cache.PersistenceResponse | undefined>;
    /**
...
export interface DatabaseArgs {
     ...
     * Specifies whether redis clients can connect using TLS-encrypted or plaintext redis protocols. Default is TLS-encrypted.
     */
    readonly clientProtocol?: pulumi.Input<string | enums.cache.Protocol>;
    /**
     ...
     * Clustering policy - default is OSSCluster. Specified at create time.
     */
    readonly clusteringPolicy?: pulumi.Input<string | enums.cache.ClusteringPolicy>;
    /**
     ...
     * Redis eviction policy - default is VolatileLRU
     */
    readonly evictionPolicy?: pulumi.Input<string | enums.cache.EvictionPolicy>;
    /**
     * Optional set of redis modules to enable in this database - modules can only be added at creation time.
     */
