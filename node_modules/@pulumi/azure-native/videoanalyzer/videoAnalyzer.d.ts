...
export declare class VideoAnalyzer extends pulumi.CustomResource {
     ...
     */
    readonly encryption: pulumi.Output<outputs.videoanalyzer.AccountEncryptionResponse>;
    /**
...
export interface VideoAnalyzerArgs {
     ...
     * The account encryption properties.
     */
    readonly encryption: pulumi.Input<inputs.videoanalyzer.AccountEncryptionArgs>;
    /**
     * The set of managed identities associated with the Video Analyzer resource.
     */
    readonly identity?: pulumi.Input<inputs.videoanalyzer.VideoAnalyzerIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The storage accounts for this resource.
     */
    readonly storageAccounts: pulumi.Input<pulumi.Input<inputs.videoanalyzer.StorageAccountArgs>[]>;
    /**
     * Resource tags.
     */
