...
export declare class ProximityPlacementGroup extends pulumi.CustomResource {
     ...
     */
    readonly availabilitySets: pulumi.Output<outputs.compute.v20210301.SubResourceWithColocationStatusResponse[]>;
    /**
     * Describes colocation status of the Proximity Placement Group.
     */
    readonly colocationStatus: pulumi.Output<outputs.compute.v20210301.InstanceViewStatusResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    readonly virtualMachineScaleSets: pulumi.Output<outputs.compute.v20210301.SubResourceWithColocationStatusResponse[]>;
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    readonly virtualMachines: pulumi.Output<outputs.compute.v20210301.SubResourceWithColocationStatusResponse[]>;
    /**
...
export interface ProximityPlacementGroupArgs {
     ...
     * Describes colocation status of the Proximity Placement Group.
     */
    readonly colocationStatus?: pulumi.Input<inputs.compute.v20210301.InstanceViewStatusArgs>;
    /**
     * Resource location
     */
     ...
     * Specifies the type of the proximity placement group. <br><br> Possible values are: <br><br> **Standard** : Co-locate resources within an Azure region or Availability Zone. <br><br> **Ultra** : For future use.
     */
    readonly proximityPlacementGroupType?: pulumi.Input<string | enums.compute.v20210301.ProximityPlacementGroupType>;
    /**
