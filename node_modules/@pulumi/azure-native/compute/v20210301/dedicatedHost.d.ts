...
export declare class DedicatedHost extends pulumi.CustomResource {
     ...
     */
    readonly instanceView: pulumi.Output<outputs.compute.v20210301.DedicatedHostInstanceViewResponse>;
    /**
     ...
     */
    readonly virtualMachines: pulumi.Output<outputs.compute.v20210301.SubResourceReadOnlyResponse[]>;
    /**
...
export interface DedicatedHostArgs {
     ...
     * Specifies the software license type that will be applied to the VMs deployed on the dedicated host. <br><br> Possible values are: <br><br> **None** <br><br> **Windows_Server_Hybrid** <br><br> **Windows_Server_Perpetual** <br><br> Default: **None**
     */
    readonly licenseType?: pulumi.Input<enums.compute.v20210301.DedicatedHostLicenseTypes>;
    /**
     * Resource location
     */
