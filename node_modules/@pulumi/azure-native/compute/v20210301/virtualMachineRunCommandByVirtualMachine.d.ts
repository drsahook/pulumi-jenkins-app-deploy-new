...
export declare class VirtualMachineRunCommandByVirtualMachine extends pulumi.CustomResource {
     ...
     */
    readonly instanceView: pulumi.Output<outputs.compute.v20210301.VirtualMachineRunCommandInstanceViewResponse>;
    /**
     * Resource location
     */
     ...
     */
    readonly parameters: pulumi.Output<outputs.compute.v20210301.RunCommandInputParameterResponse[] | undefined>;
    /**
     * The parameters used by the script.
     */
    readonly protectedParameters: pulumi.Output<outputs.compute.v20210301.RunCommandInputParameterResponse[] | undefined>;
    /**
     ...
     */
    readonly source: pulumi.Output<outputs.compute.v20210301.VirtualMachineRunCommandScriptSourceResponse | undefined>;
    /**
     * Resource tags
     */
...
export interface VirtualMachineRunCommandByVirtualMachineArgs {
     ...
     * The parameters used by the script.
     */
    readonly parameters?: pulumi.Input<pulumi.Input<inputs.compute.v20210301.RunCommandInputParameterArgs>[]>;
    /**
     * The parameters used by the script.
     */
    readonly protectedParameters?: pulumi.Input<pulumi.Input<inputs.compute.v20210301.RunCommandInputParameterArgs>[]>;
    /**
     ...
     * The source of the run command script.
     */
    readonly source?: pulumi.Input<inputs.compute.v20210301.VirtualMachineRunCommandScriptSourceArgs>;
    /**
     * Resource tags
     */
