...
export declare class DiskEncryptionSet extends pulumi.CustomResource {
     ...
     */
    readonly activeKey: pulumi.Output<outputs.compute.v20201201.KeyForDiskEncryptionSetResponse | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.compute.v20201201.EncryptionSetIdentityResponse | undefined>;
    /**
     ...
     */
    readonly previousKeys: pulumi.Output<outputs.compute.v20201201.KeyForDiskEncryptionSetResponse[]>;
    /**
...
export interface DiskEncryptionSetArgs {
     ...
     * The key vault key which is currently used by this disk encryption set.
     */
    readonly activeKey?: pulumi.Input<inputs.compute.v20201201.KeyForDiskEncryptionSetArgs>;
    /**
     ...
     * The type of key used to encrypt the data of the disk.
     */
    readonly encryptionType?: pulumi.Input<string | enums.compute.v20201201.DiskEncryptionSetType>;
    /**
     * The managed identity for the disk encryption set. It should be given permission on the key vault before it can be used to encrypt disks.
     */
    readonly identity?: pulumi.Input<inputs.compute.v20201201.EncryptionSetIdentityArgs>;
    /**
     * Resource location
     */
