...
export declare class Disk extends pulumi.CustomResource {
     ...
     */
    readonly creationData: pulumi.Output<outputs.compute.v20201201.CreationDataResponse>;
    /**
     ...
     */
    readonly encryption: pulumi.Output<outputs.compute.v20201201.EncryptionResponse | undefined>;
    /**
     * Encryption settings collection used for Azure Disk Encryption, can contain multiple encryption settings per disk or snapshot.
     */
    readonly encryptionSettingsCollection: pulumi.Output<outputs.compute.v20201201.EncryptionSettingsCollectionResponse | undefined>;
    /**
     ...
     */
    readonly propertyUpdatesInProgress: pulumi.Output<outputs.compute.v20201201.PropertyUpdatesInProgressResponse>;
    /**
     ...
     */
    readonly purchasePlan: pulumi.Output<outputs.compute.v20201201.PurchasePlanResponse | undefined>;
    /**
     * Contains the security related information for the resource.
     */
    readonly securityProfile: pulumi.Output<outputs.compute.v20201201.DiskSecurityProfileResponse | undefined>;
    /**
     * Details of the list of all VMs that have the disk attached. maxShares should be set to a value greater than one for disks to allow attaching them to multiple VMs.
     */
    readonly shareInfo: pulumi.Output<outputs.compute.v20201201.ShareInfoElementResponse[]>;
    /**
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, UltraSSD_LRS, Premium_ZRS, or StandardSSD_ZRS.
     */
    readonly sku: pulumi.Output<outputs.compute.v20201201.DiskSkuResponse | undefined>;
    /**
