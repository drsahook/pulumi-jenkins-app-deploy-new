...
export declare class ObjectReplicationPolicy extends pulumi.CustomResource {
     ...
     */
    readonly rules: pulumi.Output<outputs.storage.v20210201.ObjectReplicationPolicyRuleResponse[] | undefined>;
    /**
...
export interface ObjectReplicationPolicyArgs {
     ...
     * The storage account object replication rules.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.storage.v20210201.ObjectReplicationPolicyRuleArgs>[]>;
    /**
     * Required. Source account name.
     */
