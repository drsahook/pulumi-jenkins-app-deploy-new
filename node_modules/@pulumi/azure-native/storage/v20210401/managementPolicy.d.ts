...
export declare class ManagementPolicy extends pulumi.CustomResource {
     ...
     */
    readonly policy: pulumi.Output<outputs.storage.v20210401.ManagementPolicySchemaResponse>;
    /**
...
export interface ManagementPolicyArgs {
     ...
     * The Storage Account ManagementPolicy, in JSON format. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
     */
    readonly policy: pulumi.Input<inputs.storage.v20210401.ManagementPolicySchemaArgs>;
    /**
