...
export declare class FileShare extends pulumi.CustomResource {
     ...
     */
    readonly signedIdentifiers: pulumi.Output<outputs.storage.v20210401.SignedIdentifierResponse[] | undefined>;
    /**
...
export interface FileShareArgs {
     ...
     * Access tier for specific share. GpV2 account can choose between TransactionOptimized (default), Hot, and Cool. FileStorage account can choose Premium.
     */
    readonly accessTier?: pulumi.Input<string | enums.storage.v20210401.ShareAccessTier>;
    /**
     ...
     * The authentication protocol that is used for the file share. Can only be specified when creating a share.
     */
    readonly enabledProtocols?: pulumi.Input<string | enums.storage.v20210401.EnabledProtocols>;
    /**
     ...
     * The property is for NFS share only. The default is NoRootSquash.
     */
    readonly rootSquash?: pulumi.Input<string | enums.storage.v20210401.RootSquashType>;
    /**
     ...
     * List of stored access policies specified on the share.
     */
    readonly signedIdentifiers?: pulumi.Input<pulumi.Input<inputs.storage.v20210401.SignedIdentifierArgs>[]>;
}
