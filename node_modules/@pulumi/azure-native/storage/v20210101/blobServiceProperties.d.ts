...
export interface BlobServicePropertiesArgs {
     ...
     * The blob service properties for change feed events.
     */
    readonly changeFeed?: pulumi.Input<inputs.storage.v20210101.ChangeFeedArgs>;
    /**
     * The blob service properties for container soft delete.
     */
    readonly containerDeleteRetentionPolicy?: pulumi.Input<inputs.storage.v20210101.DeleteRetentionPolicyArgs>;
    /**
     * Specifies CORS rules for the Blob service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the Blob service.
     */
     ...
     * The blob service properties for blob soft delete.
     */
    readonly deleteRetentionPolicy?: pulumi.Input<inputs.storage.v20210101.DeleteRetentionPolicyArgs>;
    /**
     * Versioning is enabled if set to true.
     */
     ...
     * The blob service property to configure last access time based tracking policy.
     */
    readonly lastAccessTimeTrackingPolicy?: pulumi.Input<inputs.storage.v20210101.LastAccessTimeTrackingPolicyArgs>;
    /**
     ...
     * The blob service properties for blob restore policy.
     */
    readonly restorePolicy?: pulumi.Input<inputs.storage.v20210101.RestorePolicyPropertiesArgs>;
}
