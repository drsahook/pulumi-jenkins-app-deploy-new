...
export declare class ConnectedCluster extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.kubernetes.v20210301.ConnectedClusterIdentityResponse>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.kubernetes.v20210301.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ConnectedClusterArgs {
     ...
     * The identity of the connected cluster.
     */
    readonly identity: pulumi.Input<inputs.kubernetes.v20210301.ConnectedClusterIdentityArgs>;
    /**
     * The infrastructure on which the Kubernetes cluster represented by this connected cluster is running on.
     */
     ...
     * Provisioning state of the connected cluster resource.
     */
    readonly provisioningState?: pulumi.Input<string | enums.kubernetes.v20210301.ProvisioningState>;
    /**
