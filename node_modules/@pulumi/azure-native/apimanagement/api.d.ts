...
export interface ApiArgs {
     ...
     * Type of API.
     */
    readonly apiType?: pulumi.Input<string | enums.apimanagement.ApiType>;
    /**
     * Indicates the Version identifier of the API if the API is versioned
     */
     ...
     */
    readonly format?: pulumi.Input<string | enums.apimanagement.ContentFormat>;
    /**
     * Indicates if API revision is current api revision.
     */
     ...
     * Describes on which protocols the operations in this API can be invoked.
     */
    readonly protocols?: pulumi.Input<pulumi.Input<enums.apimanagement.Protocol>[]>;
    /**
     ...
     */
    readonly soapApiType?: pulumi.Input<string | enums.apimanagement.SoapApiType>;
    /**
     * API identifier of the source API.
     */
