...
export interface UserArgs {
     ...
     */
    readonly appType?: pulumi.Input<string | enums.apimanagement.v20191201.AppType>;
    /**
     * Determines the type of confirmation e-mail that will be sent to the newly created user.
     */
    readonly confirmation?: pulumi.Input<string | enums.apimanagement.v20191201.Confirmation>;
    /**
     ...
     * Collection of user identities.
     */
    readonly identities?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20191201.UserIdentityContractArgs>[]>;
    /**
     * Last name.
     */
     ...
     * Account state. Specifies whether the user is active or not. Blocked users are unable to sign into the developer portal or call any APIs of subscribed products. Default state is Active.
     */
    readonly state?: pulumi.Input<string | enums.apimanagement.v20191201.UserState>;
    /**
