...
export declare class ApiDiagnostic extends pulumi.CustomResource {
     ...
     */
    readonly backend: pulumi.Output<outputs.apimanagement.v20201201.PipelineDiagnosticSettingsResponse | undefined>;
    /**
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    readonly frontend: pulumi.Output<outputs.apimanagement.v20201201.PipelineDiagnosticSettingsResponse | undefined>;
    /**
     ...
     */
    readonly sampling: pulumi.Output<outputs.apimanagement.v20201201.SamplingSettingsResponse | undefined>;
    /**
...
export interface ApiDiagnosticArgs {
     ...
     * Specifies for what type of messages sampling settings should not apply.
     */
    readonly alwaysLog?: pulumi.Input<string | enums.apimanagement.v20201201.AlwaysLog>;
    /**
     ...
     * Diagnostic settings for incoming/outgoing HTTP messages to the Backend
     */
    readonly backend?: pulumi.Input<inputs.apimanagement.v20201201.PipelineDiagnosticSettingsArgs>;
    /**
     ...
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    readonly frontend?: pulumi.Input<inputs.apimanagement.v20201201.PipelineDiagnosticSettingsArgs>;
    /**
     * Sets correlation protocol to use for Application Insights diagnostics.
     */
    readonly httpCorrelationProtocol?: pulumi.Input<string | enums.apimanagement.v20201201.HttpCorrelationProtocol>;
    /**
     * Log the ClientIP. Default is false.
     */
     ...
     * The format of the Operation Name for Application Insights telemetries. Default is Name.
     */
    readonly operationNameFormat?: pulumi.Input<string | enums.apimanagement.v20201201.OperationNameFormat>;
    /**
     ...
     * Sampling settings for Diagnostic.
     */
    readonly sampling?: pulumi.Input<inputs.apimanagement.v20201201.SamplingSettingsArgs>;
    /**
     ...
     * The verbosity level applied to traces emitted by trace policies.
     */
    readonly verbosity?: pulumi.Input<string | enums.apimanagement.v20201201.Verbosity>;
}
