 ...
 */
export declare class OnPremiseSensor extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OnPremiseSensor;
    /**
     * Returns true if the given object is an instance of OnPremiseSensor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OnPremiseSensor;
    /**
...
export interface OnPremiseSensorArgs {
     ...
     */
    readonly onPremiseSensorName?: pulumi.Input<string>;
}
