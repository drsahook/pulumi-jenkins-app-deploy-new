...
export declare class NodeType extends pulumi.CustomResource {
     ...
     */
    readonly applicationPorts: pulumi.Output<outputs.servicefabric.v20200101preview.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly ephemeralPorts: pulumi.Output<outputs.servicefabric.v20200101preview.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly vmExtensions: pulumi.Output<outputs.servicefabric.v20200101preview.VMSSExtensionResponse[] | undefined>;
    /**
     ...
     */
    readonly vmSecrets: pulumi.Output<outputs.servicefabric.v20200101preview.VaultSecretGroupResponse[] | undefined>;
    /**
...
export interface NodeTypeArgs {
     ...
     * The capacity tags applied to the nodes in the node type, the cluster resource manager uses these tags to understand how much resource a node has.
     */
    readonly capacities?: pulumi.Input<{
     ...
     * The placement tags applied to nodes in the node type, which can be used to indicate where certain services (workload) should run.
     */
    readonly placementProperties?: pulumi.Input<{
        [key: string]: pulumi.Input<string>;
    }>;
    /**
