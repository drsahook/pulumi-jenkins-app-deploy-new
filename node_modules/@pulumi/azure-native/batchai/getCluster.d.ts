...
export interface GetClusterResult {
     ...
     */
    readonly errors: outputs.batchai.BatchAIErrorResponse[];
    /**
     ...
     */
    readonly nodeSetup?: outputs.batchai.NodeSetupResponse;
    /**
     * Counts of various node states on the cluster.
     */
    readonly nodeStateCounts: outputs.batchai.NodeStateCountsResponse;
    /**
     ...
     */
    readonly scaleSettings?: outputs.batchai.ScaleSettingsResponse;
    /**
     * Virtual network subnet resource ID the cluster nodes belong to.
     */
    readonly subnet?: outputs.batchai.ResourceIdResponse;
    /**
     ...
     */
    readonly userAccountSettings?: outputs.batchai.UserAccountSettingsResponse;
    /**
     * Virtual machine configuration (OS image) of the compute nodes. All nodes in a cluster have the same OS image configuration.
     */
    readonly virtualMachineConfiguration?: outputs.batchai.VirtualMachineConfigurationResponse;
    /**
