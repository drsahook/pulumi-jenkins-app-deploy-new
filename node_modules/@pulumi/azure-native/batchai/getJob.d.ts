...
export interface GetJobResult {
     ...
     * Caffe2 job settings.
     */
    readonly caffe2Settings?: outputs.batchai.Caffe2SettingsResponse;
    /**
     * Caffe job settings.
     */
    readonly caffeSettings?: outputs.batchai.CaffeSettingsResponse;
    /**
     * Chainer job settings.
     */
    readonly chainerSettings?: outputs.batchai.ChainerSettingsResponse;
    /**
     * Resource ID of the cluster associated with the job.
     */
    readonly cluster?: outputs.batchai.ResourceIdResponse;
    /**
     * CNTK (aka Microsoft Cognitive Toolkit) job settings.
     */
    readonly cntkSettings?: outputs.batchai.CNTKsettingsResponse;
    /**
     * Constraints associated with the Job.
     */
    readonly constraints?: outputs.batchai.JobPropertiesResponseConstraints;
    /**
     * If the container was downloaded as part of cluster setup then the same container image will be used. If not provided, the job will run on the VM.
     */
    readonly containerSettings?: outputs.batchai.ContainerSettingsResponse;
    /**
     ...
     */
    readonly customMpiSettings?: outputs.batchai.CustomMpiSettingsResponse;
    /**
     * Custom tool kit job settings.
     */
    readonly customToolkitSettings?: outputs.batchai.CustomToolkitSettingsResponse;
    /**
     * A collection of user defined environment variables to be setup for the job.
     */
    readonly environmentVariables?: outputs.batchai.EnvironmentVariableResponse[];
    /**
     * Information about the execution of a job.
     */
    readonly executionInfo?: outputs.batchai.JobPropertiesResponseExecutionInfo;
    /**
     ...
     */
    readonly horovodSettings?: outputs.batchai.HorovodSettingsResponse;
    /**
     ...
     */
    readonly inputDirectories?: outputs.batchai.InputDirectoryResponse[];
    /**
     ...
     */
    readonly jobPreparation?: outputs.batchai.JobPreparationResponse;
    /**
     ...
     */
    readonly mountVolumes?: outputs.batchai.MountVolumesResponse;
    /**
     ...
     */
    readonly outputDirectories?: outputs.batchai.OutputDirectoryResponse[];
    /**
     ...
     */
    readonly pyTorchSettings?: outputs.batchai.PyTorchSettingsResponse;
    /**
     ...
     */
    readonly secrets?: outputs.batchai.EnvironmentVariableWithSecretValueResponse[];
    /**
     ...
     */
    readonly tensorFlowSettings?: outputs.batchai.TensorFlowSettingsResponse;
    /**
