...
export declare class Job extends pulumi.CustomResource {
     ...
     */
    readonly caffeSettings: pulumi.Output<outputs.batchai.v20180301.CaffeSettingsResponse | undefined>;
    /**
     * Specifies the settings for Chainer job.
     */
    readonly chainerSettings: pulumi.Output<outputs.batchai.v20180301.ChainerSettingsResponse | undefined>;
    /**
     * Represents a resource ID. For example, for a subnet, it is the resource URL for the subnet.
     */
    readonly cluster: pulumi.Output<outputs.batchai.v20180301.ResourceIdResponse | undefined>;
    /**
     * Specifies the settings for CNTK (aka Microsoft Cognitive Toolkit) job.
     */
    readonly cntkSettings: pulumi.Output<outputs.batchai.v20180301.CNTKsettingsResponse | undefined>;
    /**
     * Constraints associated with the Job.
     */
    readonly constraints: pulumi.Output<outputs.batchai.v20180301.JobPropertiesResponseConstraints | undefined>;
    /**
     * If the container was downloaded as part of cluster setup then the same container image will be used. If not provided, the job will run on the VM.
     */
    readonly containerSettings: pulumi.Output<outputs.batchai.v20180301.ContainerSettingsResponse | undefined>;
    /**
     ...
     */
    readonly customToolkitSettings: pulumi.Output<outputs.batchai.v20180301.CustomToolkitSettingsResponse | undefined>;
    /**
     * Batch AI will setup these additional environment variables for the job.
     */
    readonly environmentVariables: pulumi.Output<outputs.batchai.v20180301.EnvironmentVariableResponse[] | undefined>;
    /**
     * Contains information about the execution of a job in the Azure Batch service.
     */
    readonly executionInfo: pulumi.Output<outputs.batchai.v20180301.JobPropertiesResponseExecutionInfo | undefined>;
    /**
    ...
    readonly inputDirectories: pulumi.Output<outputs.batchai.v20180301.InputDirectoryResponse[] | undefined>;
    /**
     ...
     */
    readonly jobOutputDirectoryPathSegment: pulumi.Output<string | undefined>;
    /**
     * The specified actions will run on all the nodes that are part of the job
     */
    readonly jobPreparation: pulumi.Output<outputs.batchai.v20180301.JobPreparationResponse | undefined>;
    /**
     ...
     */
    readonly mountVolumes: pulumi.Output<outputs.batchai.v20180301.MountVolumesResponse | undefined>;
    /**
    ...
    readonly outputDirectories: pulumi.Output<outputs.batchai.v20180301.OutputDirectoryResponse[] | undefined>;
    /**
     ...
     */
    readonly pyTorchSettings: pulumi.Output<outputs.batchai.v20180301.PyTorchSettingsResponse | undefined>;
    /**
     ...
     */
    readonly secrets: pulumi.Output<outputs.batchai.v20180301.EnvironmentVariableWithSecretValueResponse[] | undefined>;
    /**
     ...
     */
    readonly tensorFlowSettings: pulumi.Output<outputs.batchai.v20180301.TensorFlowSettingsResponse | undefined>;
    /**
