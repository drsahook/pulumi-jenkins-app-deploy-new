 ...
 */
export declare function listJobOutputFiles(args: ListJobOutputFilesArgs, opts?: pulumi.InvokeOptions): Promise<ListJobOutputFilesResult>;
...
export interface ListJobOutputFilesResult {
     ...
     */
    readonly value: outputs.batchai.v20180301.FileResponse[];
}
