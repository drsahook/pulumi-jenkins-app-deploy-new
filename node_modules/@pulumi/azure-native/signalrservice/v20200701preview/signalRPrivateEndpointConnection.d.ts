...
export declare class SignalRPrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.signalrservice.v20200701preview.PrivateEndpointResponse | undefined>;
    /**
     * Connection state
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.signalrservice.v20200701preview.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
...
export interface SignalRPrivateEndpointConnectionArgs {
     ...
     * Private endpoint associated with the private endpoint connection
     */
    readonly privateEndpoint?: pulumi.Input<inputs.signalrservice.v20200701preview.PrivateEndpointArgs>;
    /**
     ...
     * Connection state
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.signalrservice.v20200701preview.PrivateLinkServiceConnectionStateArgs>;
    /**
