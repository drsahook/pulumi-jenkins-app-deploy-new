...
export declare class SignalRPrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.signalrservice.v20210401preview.PrivateEndpointResponse | undefined>;
    /**
     * Connection state
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.signalrservice.v20210401preview.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
...
export interface SignalRPrivateEndpointConnectionArgs {
     ...
     * Private endpoint associated with the private endpoint connection
     */
    readonly privateEndpoint?: pulumi.Input<inputs.signalrservice.v20210401preview.PrivateEndpointArgs>;
    /**
     ...
     * Connection state
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.signalrservice.v20210401preview.PrivateLinkServiceConnectionStateArgs>;
    /**
