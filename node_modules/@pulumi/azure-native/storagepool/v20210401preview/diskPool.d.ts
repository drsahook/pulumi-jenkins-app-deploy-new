...
export declare class DiskPool extends pulumi.CustomResource {
     ...
     */
    readonly disks: pulumi.Output<outputs.storagepool.v20210401preview.DiskResponse[] | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.storagepool.v20210401preview.SystemMetadataResponse>;
    /**
     * Resource tags.
     */
...
export interface DiskPoolArgs {
     ...
     * List of Azure Managed Disks to attach to a Disk Pool.
     */
    readonly disks?: pulumi.Input<pulumi.Input<inputs.storagepool.v20210401preview.DiskArgs>[]>;
    /**
     * The geo-location where the resource lives.
     */
     ...
     */
    readonly sku: pulumi.Input<inputs.storagepool.v20210401preview.SkuArgs>;
    /**
     * Azure Resource ID of a Subnet for the Disk Pool.
     */
