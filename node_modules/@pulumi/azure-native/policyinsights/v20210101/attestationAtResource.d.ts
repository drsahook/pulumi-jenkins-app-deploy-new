...
export declare class AttestationAtResource extends pulumi.CustomResource {
     ...
     */
    readonly evidence: pulumi.Output<outputs.policyinsights.v20210101.AttestationEvidenceResponse[] | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.policyinsights.v20210101.SystemDataResponse>;
    /**
...
export interface AttestationAtResourceArgs {
     ...
     * The evidence supporting the compliance state set in this attestation.
     */
    readonly evidence?: pulumi.Input<pulumi.Input<inputs.policyinsights.v20210101.AttestationEvidenceArgs>[]>;
    /**
     * The time the compliance state should expire.
     */
