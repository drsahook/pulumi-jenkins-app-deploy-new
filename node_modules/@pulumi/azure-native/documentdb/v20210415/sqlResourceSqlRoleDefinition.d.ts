...
export declare class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
     ...
     */
    readonly permissions: pulumi.Output<outputs.documentdb.v20210415.PermissionResponse[] | undefined>;
    /**
...
export interface SqlResourceSqlRoleDefinitionArgs {
     ...
     * The set of operations allowed through this Role Definition.
     */
    readonly permissions?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210415.PermissionArgs>[]>;
    /**
     ...
     */
    readonly type?: pulumi.Input<enums.documentdb.v20210415.RoleDefinitionType>;
}
