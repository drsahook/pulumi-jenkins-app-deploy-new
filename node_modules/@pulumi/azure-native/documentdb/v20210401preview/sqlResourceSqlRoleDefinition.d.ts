...
export declare class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
     ...
     */
    readonly permissions: pulumi.Output<outputs.documentdb.v20210401preview.PermissionResponse[] | undefined>;
    /**
...
export interface SqlResourceSqlRoleDefinitionArgs {
     ...
     * The set of operations allowed through this Role Definition.
     */
    readonly permissions?: pulumi.Input<pulumi.Input<inputs.documentdb.v20210401preview.PermissionArgs>[]>;
    /**
     ...
     */
    readonly type?: pulumi.Input<enums.documentdb.v20210401preview.RoleDefinitionType>;
}
