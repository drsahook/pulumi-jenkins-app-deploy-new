...
export declare class DatabaseAccount extends pulumi.CustomResource {
     ...
     */
    readonly apiProperties: pulumi.Output<outputs.documentdb.ApiPropertiesResponse | undefined>;
    /**
     * The object representing the policy for taking backups on an account.
     */
    readonly backupPolicy: pulumi.Output<outputs.documentdb.ContinuousModeBackupPolicyResponse | outputs.documentdb.PeriodicModeBackupPolicyResponse | undefined>;
    /**
     * List of Cosmos DB capabilities for the account
     */
    readonly capabilities: pulumi.Output<outputs.documentdb.CapabilityResponse[] | undefined>;
    /**
     ...
     */
    readonly consistencyPolicy: pulumi.Output<outputs.documentdb.ConsistencyPolicyResponse | undefined>;
    /**
     * The CORS policy for the Cosmos DB database account.
     */
    readonly cors: pulumi.Output<outputs.documentdb.CorsPolicyResponse[] | undefined>;
    /**
     ...
     */
    readonly failoverPolicies: pulumi.Output<outputs.documentdb.FailoverPolicyResponse[]>;
    /**
     ...
     * List of IpRules.
     */
    readonly ipRules: pulumi.Output<outputs.documentdb.IpAddressOrRangeResponse[] | undefined>;
    /**
     ...
     */
    readonly locations: pulumi.Output<outputs.documentdb.LocationResponse[]>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.documentdb.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly readLocations: pulumi.Output<outputs.documentdb.LocationResponse[]>;
    /**
     ...
     */
    readonly virtualNetworkRules: pulumi.Output<outputs.documentdb.VirtualNetworkRuleResponse[] | undefined>;
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    readonly writeLocations: pulumi.Output<outputs.documentdb.LocationResponse[]>;
    /**
