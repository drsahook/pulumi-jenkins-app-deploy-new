...
export declare class CustomResourceProvider extends pulumi.CustomResource {
     ...
     */
    readonly actions: pulumi.Output<outputs.customproviders.v20180901preview.CustomRPActionRouteDefinitionResponse[] | undefined>;
    /**
     * Resource location
     */
     ...
     */
    readonly resourceTypes: pulumi.Output<outputs.customproviders.v20180901preview.CustomRPResourceTypeRouteDefinitionResponse[] | undefined>;
    /**
     * Resource tags
     */
     ...
     */
    readonly validations: pulumi.Output<outputs.customproviders.v20180901preview.CustomRPValidationsResponse[] | undefined>;
    /**
...
export interface CustomResourceProviderArgs {
     ...
     * A list of actions that the custom resource provider implements.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputs.customproviders.v20180901preview.CustomRPActionRouteDefinitionArgs>[]>;
    /**
     * Resource location
     */
     ...
     * A list of resource types that the custom resource provider implements.
     */
    readonly resourceTypes?: pulumi.Input<pulumi.Input<inputs.customproviders.v20180901preview.CustomRPResourceTypeRouteDefinitionArgs>[]>;
    /**
     * Resource tags
     */
     ...
     * A list of validations to run on the custom resource provider's requests.
     */
    readonly validations?: pulumi.Input<pulumi.Input<inputs.customproviders.v20180901preview.CustomRPValidationsArgs>[]>;
}
