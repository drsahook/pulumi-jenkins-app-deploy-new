...
export declare class BigDataPool extends pulumi.CustomResource {
     ...
     */
    readonly sparkConfigProperties: pulumi.Output<outputs.synapse.LibraryRequirementsResponse | undefined>;
    /**
...
export interface BigDataPoolArgs {
     ...
     * The level of compute power that each node in the Big Data pool has.
     */
    readonly nodeSize?: pulumi.Input<string | enums.synapse.NodeSize>;
    /**
     * The kind of nodes that the Big Data pool provides.
     */
    readonly nodeSizeFamily?: pulumi.Input<string | enums.synapse.NodeSizeFamily>;
    /**
     * The state of the Big Data pool.
     */
