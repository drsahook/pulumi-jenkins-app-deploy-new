...
class SqlDatabase extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20200401preview:SqlDatabase" }] };
    ...
    static get(name, id, opts) {
        return new SqlDatabase(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
SqlDatabase.__pulumiType = 'azure-native:synapse/v20200401preview:SqlDatabase';
