...
export interface ServerEndpointArgs {
     ...
     * Cloud Tiering.
     */
    readonly cloudTiering?: pulumi.Input<string | enums.storagesync.FeatureStatus>;
    /**
     * Friendly Name
     */
     ...
     * Policy for how namespace and files are recalled during FastDr.
     */
    readonly initialDownloadPolicy?: pulumi.Input<string | enums.storagesync.InitialDownloadPolicy>;
    /**
     * Policy for enabling follow-the-sun business models: link local cache to cloud behavior to pre-populate before local access.
     */
    readonly localCacheMode?: pulumi.Input<string | enums.storagesync.LocalCacheMode>;
    /**
     * Offline data transfer
     */
    readonly offlineDataTransfer?: pulumi.Input<string | enums.storagesync.FeatureStatus>;
    /**
     * Offline data transfer share name
     */
