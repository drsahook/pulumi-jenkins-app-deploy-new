...
export declare class StorageSyncService extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.storagesync.v20200301.PrivateEndpointConnectionResponse[]>;
    /**
...
export interface StorageSyncServiceArgs {
     ...
     * Incoming Traffic Policy
     */
    readonly incomingTrafficPolicy?: pulumi.Input<string | enums.storagesync.v20200301.IncomingTrafficPolicy>;
    /**
