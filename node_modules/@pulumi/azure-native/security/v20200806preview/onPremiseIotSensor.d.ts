 ...
 */
export declare class OnPremiseIotSensor extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OnPremiseIotSensor;
    /**
     * Returns true if the given object is an instance of OnPremiseIotSensor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OnPremiseIotSensor;
    /**
     * Resource name
     */
