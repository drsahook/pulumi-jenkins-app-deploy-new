...
export declare class AutoScaleVCore extends pulumi.CustomResource {
     ...
     */
    readonly sku: pulumi.Output<outputs.powerbidedicated.v20210101.AutoScaleVCoreSkuResponse>;
    /**
...
export interface AutoScaleVCoreArgs {
     ...
     * The SKU of the auto scale v-core resource.
     */
    readonly sku: pulumi.Input<inputs.powerbidedicated.v20210101.AutoScaleVCoreSkuArgs>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
