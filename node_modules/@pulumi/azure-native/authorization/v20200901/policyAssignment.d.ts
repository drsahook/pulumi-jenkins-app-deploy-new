...
export declare class PolicyAssignment extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.authorization.v20200901.IdentityResponse | undefined>;
    /**
     ...
     */
    readonly nonComplianceMessages: pulumi.Output<outputs.authorization.v20200901.NonComplianceMessageResponse[] | undefined>;
    /**
...
export interface PolicyAssignmentArgs {
    ...
    readonly parameters?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.authorization.v20200901.ParameterValuesValueArgs>;
    }>;
    /**
     * The name of the policy assignment.
     */
