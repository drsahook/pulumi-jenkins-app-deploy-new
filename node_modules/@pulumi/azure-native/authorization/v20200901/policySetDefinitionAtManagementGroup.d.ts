...
export declare class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
     ...
     */
    readonly policyDefinitionGroups: pulumi.Output<outputs.authorization.v20200901.PolicyDefinitionGroupResponse[] | undefined>;
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: pulumi.Output<outputs.authorization.v20200901.PolicyDefinitionReferenceResponse[]>;
    /**
...
export interface PolicySetDefinitionAtManagementGroupArgs {
    ...
    readonly parameters?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.authorization.v20200901.ParameterDefinitionsValueArgs>;
    }>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
