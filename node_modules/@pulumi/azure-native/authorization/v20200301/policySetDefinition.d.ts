...
export declare class PolicySetDefinition extends pulumi.CustomResource {
     ...
     */
    readonly policyDefinitionGroups: pulumi.Output<outputs.authorization.v20200301.PolicyDefinitionGroupResponse[] | undefined>;
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: pulumi.Output<outputs.authorization.v20200301.PolicyDefinitionReferenceResponse[]>;
    /**
...
export interface PolicySetDefinitionArgs {
    ...
    readonly parameters?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.authorization.v20200301.ParameterDefinitionsValueArgs>;
    }>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    readonly policyDefinitionGroups?: pulumi.Input<pulumi.Input<inputs.authorization.v20200301.PolicyDefinitionGroupArgs>[]>;
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: pulumi.Input<pulumi.Input<inputs.authorization.v20200301.PolicyDefinitionReferenceArgs>[]>;
    /**
     ...
     * The type of policy definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
     */
    readonly policyType?: pulumi.Input<string | enums.authorization.v20200301.PolicyType>;
}
