...
export declare class PolicyAssignment extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.authorization.v20190101.IdentityResponse | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.authorization.v20190101.PolicySkuResponse | undefined>;
    /**
...
export interface PolicyAssignmentArgs {
     ...
     * The managed identity associated with the policy assignment.
     */
    readonly identity?: pulumi.Input<inputs.authorization.v20190101.IdentityArgs>;
    /**
     * The location of the policy assignment. Only required when utilizing managed identity.
     */
     ...
     * The policy sku. This property is optional, obsolete, and will be ignored.
     */
    readonly sku?: pulumi.Input<inputs.authorization.v20190101.PolicySkuArgs>;
}
