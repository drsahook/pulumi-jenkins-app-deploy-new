...
export interface PeerAsnArgs {
     ...
     * The contact details of the peer.
     */
    readonly peerContactDetail?: pulumi.Input<pulumi.Input<inputs.peering.v20200401.ContactDetailArgs>[]>;
    /**
     * The name of the peer.
     */
     ...
     * The validation state of the ASN associated with the peer.
     */
    readonly validationState?: pulumi.Input<string | enums.peering.v20200401.ValidationState>;
}
