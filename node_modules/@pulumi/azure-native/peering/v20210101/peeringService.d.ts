...
export declare class PeeringService extends pulumi.CustomResource {
     ...
     */
    readonly sku: pulumi.Output<outputs.peering.v20210101.PeeringServiceSkuResponse | undefined>;
    /**
     * The resource tags.
     */
...
export interface PeeringServiceArgs {
     ...
     * The SKU that defines the type of the peering service.
     */
    readonly sku?: pulumi.Input<inputs.peering.v20210101.PeeringServiceSkuArgs>;
    /**
     * The resource tags.
     */
