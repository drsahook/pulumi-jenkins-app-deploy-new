...
export declare class Peering extends pulumi.CustomResource {
     ...
     */
    readonly direct: pulumi.Output<outputs.peering.v20210101.PeeringPropertiesDirectResponse | undefined>;
    /**
     * The properties that define an exchange peering.
     */
    readonly exchange: pulumi.Output<outputs.peering.v20210101.PeeringPropertiesExchangeResponse | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.peering.v20210101.PeeringSkuResponse>;
    /**
     * The resource tags.
     */
...
export interface PeeringArgs {
     ...
     * The properties that define a direct peering.
     */
    readonly direct?: pulumi.Input<inputs.peering.v20210101.PeeringPropertiesDirectArgs>;
    /**
     * The properties that define an exchange peering.
     */
    readonly exchange?: pulumi.Input<inputs.peering.v20210101.PeeringPropertiesExchangeArgs>;
    /**
     * The kind of the peering.
     */
    readonly kind: pulumi.Input<string | enums.peering.v20210101.Kind>;
    /**
     * The location of the resource.
     */
     ...
     * The SKU that defines the tier and kind of the peering.
     */
    readonly sku: pulumi.Input<inputs.peering.v20210101.PeeringSkuArgs>;
    /**
     * The resource tags.
     */
