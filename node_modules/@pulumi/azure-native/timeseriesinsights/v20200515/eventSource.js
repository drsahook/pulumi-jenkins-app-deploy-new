...
class EventSource extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:timeseriesinsights/v20200515:EventSource" }, { type: "azure-native:timeseriesinsights:EventSource" }, { type: "azure-nextgen:timeseriesinsights:EventSource" }, { type: "azure-native:timeseriesinsights/v20170228preview:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20170228preview:EventSource" }, { type: "azure-native:timeseriesinsights/v20171115:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20171115:EventSource" }, { type: "azure-native:timeseriesinsights/v20180815preview:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20180815preview:EventSource" }] };
...
/** @internal */
EventSource.__pulumiType = 'azure-native:timeseriesinsights/v20200515:EventSource';
