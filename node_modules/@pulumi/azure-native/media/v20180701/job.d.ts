...
export declare class Job extends pulumi.CustomResource {
     ...
     */
    readonly input: pulumi.Output<outputs.media.v20180701.JobInputAssetResponse | outputs.media.v20180701.JobInputClipResponse | outputs.media.v20180701.JobInputHttpResponse | outputs.media.v20180701.JobInputsResponse>;
    /**
     ...
     */
    readonly outputs: pulumi.Output<outputs.media.v20180701.JobOutputAssetResponse[]>;
    /**
...
export interface JobArgs {
     ...
     * Priority with which the job should be processed. Higher priority jobs are processed before lower priority jobs. If not set, the default is normal.
     */
    readonly priority?: pulumi.Input<string | enums.media.v20180701.Priority>;
    /**
