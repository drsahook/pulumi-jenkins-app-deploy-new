...
export declare class Transform extends pulumi.CustomResource {
     ...
     */
    readonly outputs: pulumi.Output<outputs.media.v20180701.TransformOutputResponse[]>;
    /**
...
export interface TransformArgs {
     ...
     * An array of one or more TransformOutputs that the Transform should generate.
     */
    readonly outputs: pulumi.Input<pulumi.Input<inputs.media.v20180701.TransformOutputArgs>[]>;
    /**
