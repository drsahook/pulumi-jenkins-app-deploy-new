...
export declare class ContentKeyPolicy extends pulumi.CustomResource {
     ...
     */
    readonly options: pulumi.Output<outputs.media.v20180330preview.ContentKeyPolicyOptionResponse[]>;
    /**
...
export interface ContentKeyPolicyArgs {
     ...
     * The Key Policy options.
     */
    readonly options: pulumi.Input<pulumi.Input<inputs.media.v20180330preview.ContentKeyPolicyOptionArgs>[]>;
    /**
