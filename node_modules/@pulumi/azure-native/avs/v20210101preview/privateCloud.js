...
class PrivateCloud extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            inputs["internet"] = (_a = (args ? args.internet : undefined)) !== null && _a !== void 0 ? _a : "Disabled";
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:avs/v20210101preview:PrivateCloud" }, { type: "azure-native:avs:PrivateCloud" }, { type: "azure-nextgen:avs:PrivateCloud" }, { type: "azure-native:avs/v20200320:PrivateCloud" }, { type: "azure-nextgen:avs/v20200320:PrivateCloud" }, { type: "azure-native:avs/v20200717preview:PrivateCloud" }, { type: "azure-nextgen:avs/v20200717preview:PrivateCloud" }] };
...
/** @internal */
PrivateCloud.__pulumiType = 'azure-native:avs/v20210101preview:PrivateCloud';
