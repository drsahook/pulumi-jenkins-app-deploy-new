...
export declare class PrivateCloud extends pulumi.CustomResource {
     ...
     */
    readonly circuit: pulumi.Output<outputs.avs.v20210101preview.CircuitResponse | undefined>;
    /**
     * The endpoints
     */
    readonly endpoints: pulumi.Output<outputs.avs.v20210101preview.EndpointsResponse>;
    /**
     * vCenter Single Sign On Identity Sources
     */
    readonly identitySources: pulumi.Output<outputs.avs.v20210101preview.IdentitySourceResponse[] | undefined>;
    /**
     ...
     */
    readonly managementCluster: pulumi.Output<outputs.avs.v20210101preview.ManagementClusterResponse>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.avs.v20210101preview.SkuResponse>;
    /**
     * Resource tags
     */
...
export interface PrivateCloudArgs {
     ...
     * vCenter Single Sign On Identity Sources
     */
    readonly identitySources?: pulumi.Input<pulumi.Input<inputs.avs.v20210101preview.IdentitySourceArgs>[]>;
    /**
     * Connectivity to internet is enabled or disabled
     */
    readonly internet?: pulumi.Input<string | enums.avs.v20210101preview.InternetEnum>;
    /**
     * Resource location
     */
     ...
     * The default cluster used for management
     */
    readonly managementCluster: pulumi.Input<inputs.avs.v20210101preview.ManagementClusterArgs>;
    /**
     * The block of addresses should be unique across VNet in your subscription as well as on-premise. Make sure the CIDR format is conformed to (A.B.C.D/X) where A,B,C,D are between 0 and 255, and X is between 0 and 22
     */
     ...
     * The private cloud SKU
     */
    readonly sku: pulumi.Input<inputs.avs.v20210101preview.SkuArgs>;
    /**
     * Resource tags
     */
