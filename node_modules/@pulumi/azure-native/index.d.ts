...
export { aad, aadiam, addons, advisor, agfoodplatform, alertsmanagement, analysisservices, apimanagement, appconfiguration, appplatform, attestation, authorization, automanage, automation, autonomousdevelopmentplatform, avs, azureactivedirectory, azuredata, azurestack, azurestackhci, batch, batchai, billing, blockchain, blueprint, botservice, cache, cdn, certificateregistration, changeanalysis, cognitiveservices, communication, compute, confidentialledger, config, confluent, consumption, containerinstance, containerregistry, containerservice, costmanagement, customerinsights, customproviders, databox, databoxedge, databricks, datacatalog, datadog, datafactory, datalakeanalytics, datalakestore, datamigration, dataprotection, datashare, dbformariadb, dbformysql, dbforpostgresql, delegatednetwork, deploymentmanager, desktopvirtualization, devices, deviceupdate, devops, devspaces, devtestlab, digitaltwins, documentdb, domainregistration, dynamics365fraudprotection, edgeorder, elastic, engagementfabric, enterpriseknowledgegraph, eventgrid, eventhub, extendedlocation, guestconfiguration, hanaonazure, hardwaresecuritymodules, hdinsight, healthbot, healthcareapis, hybridcompute, hybriddata, hybridnetwork, importexport, insights, intune, iotcentral, iotsecurity, iotspaces, keyvault, kubernetes, kubernetesconfiguration, kusto, labservices, logic, logz, m365securityandcompliance, machinelearning, machinelearningcompute, machinelearningexperimentation, machinelearningservices, maintenance, managedidentity, managednetwork, managedservices, management, managementpartner, maps, marketplace, media, migrate, mixedreality, netapp, network, notebooks, notificationhubs, offazure, operationalinsights, operationsmanagement, peering, policyinsights, portal, powerbi, powerbidedicated, powerplatform, providerhub, purview, quantum, recoveryservices, redhatopenshift, relay, resourcegraph, resources, saas, scheduler, search, security, securityandcompliance, securityinsights, serialconsole, servicebus, servicefabric, servicefabricmesh, signalrservice, softwareplan, solutions, sql, sqlvirtualmachine, storage, storagecache, storagepool, storagesync, storsimple, streamanalytics, subscription, synapse, testbase, timeseriesinsights, types, videoanalyzer, virtualmachineimages, visualstudio, vmwarecloudsimple, web, webpubsub, windowsesu, windowsiot, };
