    ...
    it(`correctly sets config on multiple stacks concurrently`, util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        for (let i = 0; i < stacks.length; i++) {
            ...
            dones.push((() => __awaiter(void 0, void 0, void 0, function* () {
                const stack = yield automation_1.Stack.createOrSelect(s, ws);
                for (let j = 0; j < 20; j++) {
        ...
        it(`validates ${test.currentVersion}`, () => {
            ...
            if (test.expectError) {
                if (minVersion.major < currentVersion.major) {
                    assert.throws(() => automation_1.validatePulumiVersion(minVersion, currentVersion, test.optOut), /Major version mismatch./);
                }
                else {
                    assert.throws(() => automation_1.validatePulumiVersion(minVersion, currentVersion, test.optOut), /Minimum version requirement failed./);
                }
            }
            else {
                assert.doesNotThrow(() => automation_1.validatePulumiVersion(minVersion, currentVersion, test.optOut));
            }
        });
    });
});
